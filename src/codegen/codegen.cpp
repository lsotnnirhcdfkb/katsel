...
CodeGenNS::CodeGen::CodeGen(std::string const &name) : context(name), declarator(*this), typeResolver(*this), paramVisitor(*this), declCodeGen(*this), stmtCodeGen(*this), exprCodeGen(*this) {}
