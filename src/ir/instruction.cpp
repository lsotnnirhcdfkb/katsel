...
// INSTR CPP START
IR::Instrs::Copy::Copy(IR::Register& target, ASTValue val): target(target), val(val) {
    ASSERT(&target.type() == &val.type())
}
void IR::Instrs::Copy::accept(InstructionVisitor &v) const { v.visit(*this); }

IR::Instrs::Or::Or(IR::Register& target, ASTValue lhs, ASTValue rhs): target(target), lhs(lhs), rhs(rhs) {
...
IR::Instrs::And::And(IR::Register& target, ASTValue lhs, ASTValue rhs): target(target), lhs(lhs), rhs(rhs) {
    ASSERT(dynamic_cast<BoolType const *>(&target.type()))
    ASSERT(dynamic_cast<BoolType const *>(&lhs.type()))
    ASSERT(&lhs.type() == &rhs.type())
}
...
IR::Instrs::Not::Not(IR::Register& target, ASTValue op): target(target), op(op) {
    ASSERT(dynamic_cast<BoolType const *>(&target.type()))
}
void IR::Instrs::Not::accept(InstructionVisitor &v) const { v.visit(*this); }

IR::Instrs::ICmpNE::ICmpNE(IR::Register& target, ASTValue lhs, ASTValue rhs): target(target), lhs(lhs), rhs(rhs) {
    ASSERT(dynamic_cast<BoolType const *>(&target.type()))
    ASSERT(&lhs.type() == &rhs.type())
}
void IR::Instrs::ICmpNE::accept(InstructionVisitor &v) const { v.visit(*this); }

IR::Instrs::ICmpEQ::ICmpEQ(IR::Register& target, ASTValue lhs, ASTValue rhs): target(target), lhs(lhs), rhs(rhs) {
    ASSERT(dynamic_cast<BoolType const *>(&target.type()))
    ASSERT(&lhs.type() == &rhs.type())
}
void IR::Instrs::ICmpEQ::accept(InstructionVisitor &v) const { v.visit(*this); }

IR::Instrs::ICmpLT::ICmpLT(IR::Register& target, ASTValue lhs, ASTValue rhs): target(target), lhs(lhs), rhs(rhs) {
    ASSERT(dynamic_cast<BoolType const *>(&target.type()))
    ASSERT(&lhs.type() == &rhs.type())
}
void IR::Instrs::ICmpLT::accept(InstructionVisitor &v) const { v.visit(*this); }

IR::Instrs::ICmpGT::ICmpGT(IR::Register& target, ASTValue lhs, ASTValue rhs): target(target), lhs(lhs), rhs(rhs) {
    ASSERT(dynamic_cast<BoolType const *>(&target.type()))
    ASSERT(&lhs.type() == &rhs.type())
}
void IR::Instrs::ICmpGT::accept(InstructionVisitor &v) const { v.visit(*this); }

IR::Instrs::ICmpLE::ICmpLE(IR::Register& target, ASTValue lhs, ASTValue rhs): target(target), lhs(lhs), rhs(rhs) {
    ASSERT(dynamic_cast<BoolType const *>(&target.type()))
    ASSERT(&lhs.type() == &rhs.type())
}
void IR::Instrs::ICmpLE::accept(InstructionVisitor &v) const { v.visit(*this); }

IR::Instrs::ICmpGE::ICmpGE(IR::Register& target, ASTValue lhs, ASTValue rhs): target(target), lhs(lhs), rhs(rhs) {
    ASSERT(dynamic_cast<BoolType const *>(&target.type()))
    ASSERT(&lhs.type() == &rhs.type())
}
void IR::Instrs::ICmpGE::accept(InstructionVisitor &v) const { v.visit(*this); }

IR::Instrs::IAdd::IAdd(IR::Register& target, ASTValue lhs, ASTValue rhs): target(target), lhs(lhs), rhs(rhs) {
...
IR::Instrs::ISub::ISub(IR::Register& target, ASTValue lhs, ASTValue rhs): target(target), lhs(lhs), rhs(rhs) {
    ASSERT(&target.type() == &lhs.type())
    ASSERT(dynamic_cast<IntType const *>(&lhs.type()) || dynamic_cast<GenericIntType const *>(&lhs.type()))
    ASSERT(&lhs.type() == &rhs.type())
}
...
IR::Instrs::IMult::IMult(IR::Register& target, ASTValue lhs, ASTValue rhs): target(target), lhs(lhs), rhs(rhs) {
    ASSERT(&target.type() == &lhs.type())
    ASSERT(dynamic_cast<IntType const *>(&lhs.type()) || dynamic_cast<GenericIntType const *>(&lhs.type()))
    ASSERT(&lhs.type() == &rhs.type())
}
...
IR::Instrs::IDiv::IDiv(IR::Register& target, ASTValue lhs, ASTValue rhs): target(target), lhs(lhs), rhs(rhs) {
    ASSERT(&target.type() == &lhs.type())
    ASSERT(dynamic_cast<IntType const *>(&lhs.type()) || dynamic_cast<GenericIntType const *>(&lhs.type()))
    ASSERT(&lhs.type() == &rhs.type())
}
...
IR::Instrs::IMod::IMod(IR::Register& target, ASTValue lhs, ASTValue rhs): target(target), lhs(lhs), rhs(rhs) {
    ASSERT(&target.type() == &lhs.type())
    ASSERT(dynamic_cast<IntType const *>(&lhs.type()) || dynamic_cast<GenericIntType const *>(&lhs.type()))
    ASSERT(&lhs.type() == &rhs.type())
}
...
IR::Instrs::INeg::INeg(IR::Register& target, ASTValue op): target(target), op(op) {
...
IR::Instrs::FCmpNE::FCmpNE(IR::Register& target, ASTValue lhs, ASTValue rhs): target(target), lhs(lhs), rhs(rhs) {
    ASSERT(dynamic_cast<BoolType const *>(&target.type()))
...
IR::Instrs::FCmpEQ::FCmpEQ(IR::Register& target, ASTValue lhs, ASTValue rhs): target(target), lhs(lhs), rhs(rhs) {
    ASSERT(dynamic_cast<BoolType const *>(&target.type()))
    ASSERT(dynamic_cast<FloatType const *>(&lhs.type()) || dynamic_cast<GenericFloatType const *>(&lhs.type()))
    ASSERT(&lhs.type() == &rhs.type())
}
...
IR::Instrs::FCmpLT::FCmpLT(IR::Register& target, ASTValue lhs, ASTValue rhs): target(target), lhs(lhs), rhs(rhs) {
    ASSERT(dynamic_cast<BoolType const *>(&target.type()))
    ASSERT(dynamic_cast<FloatType const *>(&lhs.type()) || dynamic_cast<GenericFloatType const *>(&lhs.type()))
    ASSERT(&lhs.type() == &rhs.type())
}
...
IR::Instrs::FCmpGT::FCmpGT(IR::Register& target, ASTValue lhs, ASTValue rhs): target(target), lhs(lhs), rhs(rhs) {
    ASSERT(dynamic_cast<BoolType const *>(&target.type()))
    ASSERT(dynamic_cast<FloatType const *>(&lhs.type()) || dynamic_cast<GenericFloatType const *>(&lhs.type()))
    ASSERT(&lhs.type() == &rhs.type())
}
...
IR::Instrs::FCmpLE::FCmpLE(IR::Register& target, ASTValue lhs, ASTValue rhs): target(target), lhs(lhs), rhs(rhs) {
    ASSERT(dynamic_cast<BoolType const *>(&target.type()))
    ASSERT(dynamic_cast<FloatType const *>(&lhs.type()) || dynamic_cast<GenericFloatType const *>(&lhs.type()))
    ASSERT(&lhs.type() == &rhs.type())
}
...
IR::Instrs::FCmpGE::FCmpGE(IR::Register& target, ASTValue lhs, ASTValue rhs): target(target), lhs(lhs), rhs(rhs) {
    ASSERT(dynamic_cast<BoolType const *>(&target.type()))
    ASSERT(dynamic_cast<FloatType const *>(&lhs.type()) || dynamic_cast<GenericFloatType const *>(&lhs.type()))
    ASSERT(&lhs.type() == &rhs.type())
}
...
IR::Instrs::FAdd::FAdd(IR::Register& target, ASTValue lhs, ASTValue rhs): target(target), lhs(lhs), rhs(rhs) {
    ASSERT(&target.type() == &lhs.type())
    ASSERT(dynamic_cast<FloatType const *>(&lhs.type()) || dynamic_cast<GenericFloatType const *>(&lhs.type()))
    ASSERT(&lhs.type() == &rhs.type())
}
...
IR::Instrs::FSub::FSub(IR::Register& target, ASTValue lhs, ASTValue rhs): target(target), lhs(lhs), rhs(rhs) {
    ASSERT(&target.type() == &lhs.type())
    ASSERT(dynamic_cast<FloatType const *>(&lhs.type()) || dynamic_cast<GenericFloatType const *>(&lhs.type()))
    ASSERT(&lhs.type() == &rhs.type())
}
...
IR::Instrs::FMult::FMult(IR::Register& target, ASTValue lhs, ASTValue rhs): target(target), lhs(lhs), rhs(rhs) {
    ASSERT(&target.type() == &lhs.type())
    ASSERT(dynamic_cast<FloatType const *>(&lhs.type()) || dynamic_cast<GenericFloatType const *>(&lhs.type()))
    ASSERT(&lhs.type() == &rhs.type())
}
...
IR::Instrs::FDiv::FDiv(IR::Register& target, ASTValue lhs, ASTValue rhs): target(target), lhs(lhs), rhs(rhs) {
    ASSERT(&target.type() == &lhs.type())
    ASSERT(dynamic_cast<FloatType const *>(&lhs.type()) || dynamic_cast<GenericFloatType const *>(&lhs.type()))
    ASSERT(&lhs.type() == &rhs.type())
}
...
IR::Instrs::FMod::FMod(IR::Register& target, ASTValue lhs, ASTValue rhs): target(target), lhs(lhs), rhs(rhs) {
    ASSERT(&target.type() == &lhs.type())
    ASSERT(dynamic_cast<FloatType const *>(&lhs.type()) || dynamic_cast<GenericFloatType const *>(&lhs.type()))
    ASSERT(&lhs.type() == &rhs.type())
}
...
IR::Instrs::FNeg::FNeg(IR::Register& target, ASTValue op): target(target), op(op) {
    ASSERT(&target.type() == &op.type())
...
IR::Instrs::BitXor::BitXor(IR::Register& target, ASTValue lhs, ASTValue rhs): target(target), lhs(lhs), rhs(rhs) {
    ASSERT(&target.type() == &lhs.type())
    ASSERT(dynamic_cast<IntType const *>(&lhs.type()) || dynamic_cast<GenericIntType const *>(&lhs.type()))
    ASSERT(&lhs.type() == &rhs.type())
}
...
IR::Instrs::BitOr::BitOr(IR::Register& target, ASTValue lhs, ASTValue rhs): target(target), lhs(lhs), rhs(rhs) {
    ASSERT(&target.type() == &lhs.type())
    ASSERT(dynamic_cast<IntType const *>(&lhs.type()) || dynamic_cast<GenericIntType const *>(&lhs.type()))
    ASSERT(&lhs.type() == &rhs.type())
}
...
IR::Instrs::BitAnd::BitAnd(IR::Register& target, ASTValue lhs, ASTValue rhs): target(target), lhs(lhs), rhs(rhs) {
    ASSERT(&target.type() == &lhs.type())
    ASSERT(dynamic_cast<IntType const *>(&lhs.type()) || dynamic_cast<GenericIntType const *>(&lhs.type()))
    ASSERT(&lhs.type() == &rhs.type())
}
...
IR::Instrs::BitNot::BitNot(IR::Register& target, ASTValue op): target(target), op(op) {
    ASSERT(&target.type() == &op.type())
    ASSERT(dynamic_cast<IntType const *>(&op.type()) || dynamic_cast<GenericIntType const *>(&op.type()))
}
void IR::Instrs::BitNot::accept(InstructionVisitor &v) const { v.visit(*this); }

IR::Instrs::ShiftR::ShiftR(IR::Register& target, ASTValue lhs, ASTValue rhs): target(target), lhs(lhs), rhs(rhs) {
    ASSERT(&target.type() == &lhs.type())
    ASSERT(dynamic_cast<IntType const *>(&lhs.type()) || dynamic_cast<GenericIntType const *>(&lhs.type()))
    ASSERT(dynamic_cast<IntType const *>(&lhs.type()) || dynamic_cast<GenericIntType const *>(&lhs.type()))
}
...
IR::Instrs::ShiftL::ShiftL(IR::Register& target, ASTValue lhs, ASTValue rhs): target(target), lhs(lhs), rhs(rhs) {
    ASSERT(&target.type() == &lhs.type())
    ASSERT(dynamic_cast<IntType const *>(&lhs.type()) || dynamic_cast<GenericIntType const *>(&lhs.type()))
    ASSERT(dynamic_cast<IntType const *>(&lhs.type()) || dynamic_cast<GenericIntType const *>(&lhs.type()))
}
...
IR::Instrs::NoOpCast::NoOpCast(IR::Register& target, ASTValue op, NNPtr<Type const> newt): target(target), op(op), newt(newt) {
    ASSERT(&target.type() == &*newt)
}
void IR::Instrs::NoOpCast::accept(InstructionVisitor &v) const { v.visit(*this); }

IR::Instrs::IntToInt::IntToInt(IR::Register& target, ASTValue op, NNPtr<IntType const> newt): target(target), op(op), newt(newt) {
    ASSERT(&target.type() == &*newt)
    ASSERT(dynamic_cast<IntType const *>(&op.type()) || dynamic_cast<GenericIntType const *>(&op.type()))
}
void IR::Instrs::IntToInt::accept(InstructionVisitor &v) const { v.visit(*this); }

IR::Instrs::IntToFloat::IntToFloat(IR::Register& target, ASTValue op, NNPtr<FloatType const> newt): target(target), op(op), newt(newt) {
    ASSERT(&target.type() == &*newt)
    ASSERT(dynamic_cast<IntType const *>(&op.type()) || dynamic_cast<GenericIntType const *>(&op.type()))
}
void IR::Instrs::IntToFloat::accept(InstructionVisitor &v) const { v.visit(*this); }

IR::Instrs::FloatToFloat::FloatToFloat(IR::Register& target, ASTValue op, NNPtr<FloatType const> newt): target(target), op(op), newt(newt) {
    ASSERT(&target.type() == &*newt)
    ASSERT(dynamic_cast<FloatType const *>(&op.type()) || dynamic_cast<GenericFloatType const *>(&op.type()))
}
void IR::Instrs::FloatToFloat::accept(InstructionVisitor &v) const { v.visit(*this); }

IR::Instrs::FloatToInt::FloatToInt(IR::Register& target, ASTValue op, NNPtr<IntType const> newt): target(target), op(op), newt(newt) {
    ASSERT(&target.type() == &*newt)
    ASSERT(dynamic_cast<FloatType const *>(&op.type()) || dynamic_cast<GenericFloatType const *>(&op.type()))
}
void IR::Instrs::FloatToInt::accept(InstructionVisitor &v) const { v.visit(*this); }

IR::Instrs::Call::Call(IR::Register& target, NNPtr<Function const> f, std::vector<ASTValue> args): target(target), f(f), args(args) {
...
IR::Instrs::DerefPtr::DerefPtr(IR::Register& target, ASTValue ptr): target(target), ptr(ptr) {
    ASSERT(dynamic_cast<PointerType const *>(&ptr.type()))
}
void IR::Instrs::DerefPtr::accept(InstructionVisitor &v) const { v.visit(*this); }

IR::Instrs::PtrArith::PtrArith(IR::Register& target, ASTValue ptr, ASTValue offset): target(target), ptr(ptr), offset(offset) {
    ASSERT(dynamic_cast<PointerType const *>(&ptr.type()))
