...
void E0011(Span const &expected, std::string const &name) {
    Errors::SimpleError e = Errors::SimpleError(Errors::SimpleError::Type::ERROR, expected, "E0011", "expected");
    auto sect = std::make_unique<Errors::Sections::Underlines>();
...
void E0012(Located<NNPtr<IR::Value>> const &lhs, Span const &op) {
    Errors::SimpleError e = Errors::SimpleError(Errors::SimpleError::Type::ERROR, op, "E0012", "lhs-unsupported-op");
    auto sect = std::make_unique<Errors::Sections::Underlines>();
...
void E0013(Located<NNPtr<IR::Value>> const &operand, Located<ASTNS::UnaryOperator> const &op) {
    Errors::SimpleError e = Errors::SimpleError(Errors::SimpleError::Type::ERROR, op.span, "E0013", "unary-unsupported-op");
    auto sect = std::make_unique<Errors::Sections::Underlines>();
...
void E0014(Located<NNPtr<IR::Value>> const &func, Span const &oparn) {
    Errors::SimpleError e = Errors::SimpleError(Errors::SimpleError::Type::ERROR, oparn, "E0014", "call-noncallable");
    auto sect = std::make_unique<Errors::Sections::Underlines>();
...
void E0015(Located<NNPtr<IR::Value>> const &arg, IR::Type const &expected) {
    Errors::SimpleError e = Errors::SimpleError(Errors::SimpleError::Type::ERROR, arg.span, "E0015", "incorrect-arg");
    auto sect = std::make_unique<Errors::Sections::Underlines>();
...
void E0016(Located<NNPtr<IR::Value>> const &truev, Located<NNPtr<IR::Value>> const &falsev, Span const &iftok, Span const &elsetok) {
    Errors::SimpleError e = Errors::SimpleError(Errors::SimpleError::Type::ERROR, iftok, "E0016", "confl-tys-ifexpr");
    auto sect = std::make_unique<Errors::Sections::Underlines>();
...
void E0017(Located<NNPtr<IR::Value>> const &lhs, Located<NNPtr<IR::Value>> const &rhs, Span const &eq) {
    Errors::SimpleError e = Errors::SimpleError(Errors::SimpleError::Type::ERROR, eq, "E0017", "assign-conflict-tys");
    auto sect = std::make_unique<Errors::Sections::Underlines>();
...
void E0018(Located<NNPtr<IR::Value>> const &val, IR::Function const &f) {
    Errors::SimpleError e = Errors::SimpleError(Errors::SimpleError::Type::ERROR, val.span, "E0018", "conflict-ret-ty");
    auto sect = std::make_unique<Errors::Sections::Underlines>();
...
void E0019(Span const &op, Located<NNPtr<IR::Value>> const &val) {
    Errors::SimpleError e = Errors::SimpleError(Errors::SimpleError::Type::ERROR, val.span, "E0019", "no-deref");
    auto sect = std::make_unique<Errors::Sections::Underlines>();
...
void E0020(Span const &eq, Span const &name, ASTNS::Type const &type_ast, Located<NNPtr<IR::Value>> const &init, IR::Type const &expected_type) {
    Errors::SimpleError e = Errors::SimpleError(Errors::SimpleError::Type::ERROR, eq, "E0020", "conflict-var-init-ty");
    auto sect = std::make_unique<Errors::Sections::Underlines>();
...
void E0021(ASTNS::AST const &ast, Located<NNPtr<IR::Value>> v, IR::Type const &newty) {
    Errors::SimpleError e = Errors::SimpleError(Errors::SimpleError::Type::ERROR, ast, "E0021", "invalid-cast");
    auto sect = std::make_unique<Errors::Sections::Underlines>();
...
void E0022(Located<NNPtr<IR::Value>> const &lhs, Located<NNPtr<IR::Value>> const &rhs, Span const &op) {
    Errors::SimpleError e = Errors::SimpleError(Errors::SimpleError::Type::ERROR, op, "E0022", "conflict-tys-binary-op");
    auto sect = std::make_unique<Errors::Sections::Underlines>();
    sect->messages.push_back(Errors::Sections::Underlines::Message { lhs.span, '~', format("{}", lhs.value->type()), A_BOLD });
    sect->messages.push_back(Errors::Sections::Underlines::Message { rhs.span, '~', format("{}", rhs.value->type()), A_BOLD });
...
void E0023(Located<NNPtr<IR::Value>> const &v) {
    Errors::SimpleError e = Errors::SimpleError(Errors::SimpleError::Type::ERROR, v.span, "E0023", "cond-not-bool");
    auto sect = std::make_unique<Errors::Sections::Underlines>();
...
void E0024(Located<NNPtr<IR::Value>> const &lhs, Located<ASTNS::BinaryOperator> const &optok, Located<NNPtr<IR::Value>> const &rhs) {
    Errors::SimpleError e = Errors::SimpleError(Errors::SimpleError::Type::ERROR, optok.span, "E0024", "ptr-arith-rhs-not-num");
    auto sect = std::make_unique<Errors::Sections::Underlines>();
    sect->messages.push_back(Errors::Sections::Underlines::Message { rhs.span, '~', format("{}", rhs.value->type()), A_BOLD });
...
void E0025(Located<NNPtr<IR::Value>> const &truev, Span const &iftok) {
    Errors::SimpleError e = Errors::SimpleError(Errors::SimpleError::Type::ERROR, iftok, "E0025", "no-else-not-void");
    auto sect = std::make_unique<Errors::Sections::Underlines>();
...
void E0026(ASTNS::ThisParam const &p) {
    Errors::SimpleError e = Errors::SimpleError(Errors::SimpleError::Type::ERROR, p, "E0026", "typeless-this");
    auto sect = std::make_unique<Errors::Sections::Underlines>();
...
void E0027(IR::Function const &func, ASTNS::AST const &func_ref_ast, Span const &oparn, std::vector<Located<NNPtr<IR::Value>>> const &args) {
    Errors::SimpleError e = Errors::SimpleError(Errors::SimpleError::Type::ERROR, oparn, "E0027", "wrong-num-args");
    auto sect = std::make_unique<Errors::Sections::Underlines>();
...
void E0028(Span const &name, IR::Value const &val) {
    Errors::SimpleError e = Errors::SimpleError(Errors::SimpleError::Type::ERROR, name, "E0028", "redecl-sym");
    auto sect = std::make_unique<Errors::Sections::Underlines>();
...
void E0029(Span const &path) {
    Errors::SimpleError e = Errors::SimpleError(Errors::SimpleError::Type::ERROR, path, "E0029", "undecl-symb");
    auto sect = std::make_unique<Errors::Sections::Underlines>();
...
void E0030(ASTNS::ParamB const &param, IR::Register const &prev) {
    Errors::SimpleError e = Errors::SimpleError(Errors::SimpleError::Type::ERROR, param, "E0030", "redecl-param");
    auto sect = std::make_unique<Errors::Sections::Underlines>();
...
void E0031(Span const &name, IR::Register const &prev) {
    Errors::SimpleError e = Errors::SimpleError(Errors::SimpleError::Type::ERROR, name, "E0031", "redecl-var");
    auto sect = std::make_unique<Errors::Sections::Underlines>();
...
void E0032(Span const &notty, ASTNS::AST const &decl_ast) {
    Errors::SimpleError e = Errors::SimpleError(Errors::SimpleError::Type::ERROR, notty, "E0032", "not-a-type");
    auto sect = std::make_unique<Errors::Sections::Underlines>();
...
void E0033(IR::DeclSymbol const &prev, Span const &current) {
    Errors::SimpleError e = Errors::SimpleError(Errors::SimpleError::Type::ERROR, current, "E0033", "no-member-in");
    auto sect = std::make_unique<Errors::Sections::Underlines>();
...
void E0034(Span const &th) {
    Errors::SimpleError e = Errors::SimpleError(Errors::SimpleError::Type::ERROR, th, "E0034", "no-this");
    auto sect = std::make_unique<Errors::Sections::Underlines>();
...
void E0035(Located<NNPtr<IR::Value>> const &op, Span const &name) {
    Errors::SimpleError e = Errors::SimpleError(Errors::SimpleError::Type::ERROR, name, "E0035", "no-method");
    auto sect = std::make_unique<Errors::Sections::Underlines>();
...
void E0036(Located<NNPtr<IR::Value>> const &op, Span const &name) {
    Errors::SimpleError e = Errors::SimpleError(Errors::SimpleError::Type::ERROR, name, "E0036", "no-field");
    auto sect = std::make_unique<Errors::Sections::Underlines>();
...
void E0037(Span const &op, Located<NNPtr<IR::Value>> const &val) {
    Errors::SimpleError e = Errors::SimpleError(Errors::SimpleError::Type::ERROR, val.span, "E0037", "addrof-not-lvalue");
    auto sect = std::make_unique<Errors::Sections::Underlines>();
...
void E0038(Span const &eq, Located<NNPtr<IR::Value>> const &lhs) {
    Errors::SimpleError e = Errors::SimpleError(Errors::SimpleError::Type::ERROR, eq, "E0038", "assign-invalid-lhs");
    auto sect = std::make_unique<Errors::Sections::Underlines>();
...
void E0039(Located<NNPtr<IR::Value>> const &v, Span const &eq, IR::Register const &reg) {
    Errors::SimpleError e = Errors::SimpleError(Errors::SimpleError::Type::ERROR, v.span, "E0039", "assign-not-mut");
    auto sect = std::make_unique<Errors::Sections::Underlines>();
...
void E0040(Span const &op, IR::Register const &reg) {
    Errors::SimpleError e = Errors::SimpleError(Errors::SimpleError::Type::ERROR, op, "E0040", "mut-addrof-nonmut-op");
    auto sect = std::make_unique<Errors::Sections::Underlines>();
...
void E0041(Span const &dollar) {
    Errors::SimpleError e = Errors::SimpleError(Errors::SimpleError::Type::ERROR, dollar, "E0041", "no-suppress");
    auto sect = std::make_unique<Errors::Sections::Underlines>();
...
void E0042(ASTNS::ThisParam const &ast) {
    Errors::SimpleError e = Errors::SimpleError(Errors::SimpleError::Type::ERROR, ast, "E0042", "this-not-first");
    auto sect = std::make_unique<Errors::Sections::Underlines>();
