...
void E0003(Token const &tok) {
    Error e = Error(MsgType::ERROR, tok.span, "E0003", "invalid-intlit-base");
    e.underline(Underline(tok.span, '^')
...
void E0005(Token const &tok) {
    Error e = Error(MsgType::ERROR, tok.span, "E0005", "invalid-char-floatlit");
    e.underline(Underline(tok.span, '^')
...
void E0006(Token const &tok) {
    Error e = Error(MsgType::ERROR, tok.span, "E0006", "invalid-char-for-base");
    e.underline(Underline(tok.span, '^')
...
void E0007(Token const &tok) {
    Error e = Error(MsgType::ERROR, tok.span, "E0007", "intlit-no-digits");
    e.underline(Underline(tok.span, '^')
...
void E0008(Token const &tok) {
    Error e = Error(MsgType::ERROR, tok.span, "E0008", "multichar-charlit");
    e.underline(Underline(tok.span, '^')
...
void E0009(Token const &tok) {
    Error e = Error(MsgType::ERROR, tok.span, "E0009", "unterm-multiline-comment");
    e.underline(Underline(tok.span, '^')
...
void E0010(Token const &tok) {
    Error e = Error(MsgType::ERROR, tok.span, "E0010", "dedent-nomatch");
    e.underline(Underline(tok.span, '^')
...
void E0011(Token const &tok) {
    Error e = Error(MsgType::ERROR, tok.span, "E0011", "char-after-backslash");
    e.underline(Underline(tok.span, '^')
...
void E0012(Token const &lookahead, Token const &lasttok, std::vector<std::string> const &expectations) {
    Error e = Error(MsgType::ERROR, lookahead.span, "E0012", "unrecoverable-invalid-syntax");
...
void E0013(Token const &lookahead, Token const &lasttok, std::string const &bestfix, std::vector<std::string> const &expectations) {
    Error e = Error(MsgType::ERROR, lookahead.span, "E0013", "simple-invalid-syntax");
    e.underline(Underline(lookahead.span, '^')
        .error(format("unexpected {}", lookahead.stringify_type()))
        .note(bestfix)
    );
...
void E0014(Token const &lookahead, Token const &lasttok, Token const &panicuntil, std::vector<std::string> const &expectations) {
    Error e = Error(MsgType::ERROR, lookahead.span, "E0014", "panicking-invalid-syntax");
    e.underline(Underline(lookahead.span, '^')
        .error(format("unexpected {}", lookahead.stringify_type()))
    );
...
void E0015(IR::ASTValue const &lhs, Token const &op) {
    Error e = Error(MsgType::ERROR, op.span, "E0015", "lhs-unsupported-op");
...
void E0016(IR::ASTValue const &operand, Token const &_operator) {
    Error e = Error(MsgType::ERROR, _operator.span, "E0016", "unary-unsupported-op");
...
void E0017(IR::ASTValue const &func, Token const &oparn) {
    Error e = Error(MsgType::ERROR, oparn.span, "E0017", "call-noncallable");
...
void E0019(IR::ASTValue const &truev, IR::ASTValue const &falsev, Token const &iftok, Token const &elsetok) {
    Error e = Error(MsgType::ERROR, iftok.span, "E0019", "confl-tys-ifexpr");
...
void E0020(IR::ASTValue const &lhs, IR::ASTValue const &rhs, Token const &eq) {
    Error e = Error(MsgType::ERROR, eq.span, "E0020", "assign-conflict-tys");
...
void E0023(Token const &eq, Token const &name, ASTNS::Type const &type_ast, IR::ASTValue const &init, IR::Type const &expected_type) {
    Error e = Error(MsgType::ERROR, eq.span, "E0023", "conflict-var-init-ty");
    e.underline(Underline(eq.span, '~')
    );
...
void E0025(IR::ASTValue const &lhs, IR::ASTValue const &rhs, Token const &op) {
    Error e = Error(MsgType::ERROR, op.span, "E0025", "conflict-tys-binary-op");
    e.underline(Underline(lhs, '~')
        .note(format("{}", lhs.type()))
    );
    e.underline(Underline(rhs, '~')
...
void E0027(IR::ASTValue const &lhs, Token const &optok, IR::ASTValue const &rhs) {
    Error e = Error(MsgType::ERROR, optok.span, "E0027", "ptr-arith-rhs-not-num");
    e.underline(Underline(lhs, '~')
    );
    e.underline(Underline(rhs, '~')
        .note(format("{}", rhs.type()))
...
void E0028(IR::ASTValue const &truev, Token const &iftok) {
    Error e = Error(MsgType::ERROR, iftok.span, "E0028", "no-else-not-void");
    e.underline(Underline(iftok.span, '^')
...
void E0030(IR::Function const &func, ASTNS::AST const &func_ref_ast, Token const &oparn, std::vector<IR::ASTValue> const &args) {
    Error e = Error(MsgType::ERROR, oparn.span, "E0030", "wrong-num-args");
...
void E0031(Token const &name, IR::Value const &val) {
    Error e = Error(MsgType::ERROR, name.span, "E0031", "redecl-sym");
    e.underline(Underline(name.span, '^')
...
void E0034(Token const &name, IR::Instrs::Register const &prev) {
    Error e = Error(MsgType::ERROR, name.span, "E0034", "redecl-var");
    e.underline(Underline(name.span, '^')
...
void E0036(IR::DeclSymbol const &prev, Token const &current) {
    Error e = Error(MsgType::ERROR, current.span, "E0036", "no-member-in");
...
void E0037(Token const &th) {
    Error e = Error(MsgType::ERROR, th.span, "E0037", "no-this");
...
void E0038(IR::ASTValue const &op, Token const &name) {
    Error e = Error(MsgType::ERROR, name.span, "E0038", "no-method");
    e.underline(Underline(name.span, '^')
...
void E0039(IR::ASTValue const &op, Token const &name) {
    Error e = Error(MsgType::ERROR, name.span, "E0039", "no-field");
    e.underline(Underline(name.span, '^')
...
void E0041(Token const &eq, IR::ASTValue const &lhs) {
    Error e = Error(MsgType::ERROR, eq.span, "E0041", "assign-invalid-lhs");
    e.underline(Underline(eq.span, '^')
...
void E0043(Token const &op, IR::Instrs::DerefPtr const &as_deref) {
    Error e = Error(MsgType::ERROR, op.span, "E0043", "mut-addrof-nonmut-op");
    e.underline(Underline(op.span, '^')
...
void E0044(Span const &dollar) {
    Error e = Error(MsgType::ERROR, dollar, "E0044", "no-suppress");
