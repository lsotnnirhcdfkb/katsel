...
WrongNumArgs::WrongNumArgs(NNPtr<IR::Function const> const &func, NNPtr<ASTNS::AST> const &func_ref_ast, Span const &oparn, std::vector<Located<NNPtr<IR::Value>>> const &args): func(func), func_ref_ast(func_ref_ast), oparn(oparn), args(args) {}
