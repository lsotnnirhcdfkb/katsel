...
void LocationVisitor::visitAnotherArg(ASTNS::AnotherArg *ast)
{
    switch (ast->form)
    {
...
void LocationVisitor::visitAnotherDecl(ASTNS::AnotherDecl *ast)
{
    switch (ast->form)
    {
...
void LocationVisitor::visitAnotherParam(ASTNS::AnotherParam *ast)
{
    switch (ast->form)
    {
...
void LocationVisitor::visitAnotherStmt(ASTNS::AnotherStmt *ast)
{
    switch (ast->form)
    {
...
void LocationVisitor::visitAnotherVarStmtItem(ASTNS::AnotherVarStmtItem *ast)
{
    switch (ast->form)
    {
...
void LocationVisitor::visitBlockedExpr(ASTNS::BlockedExpr *ast)
{
    switch (ast->form)
    {
...
void LocationVisitor::visitImplRet_OPT(ASTNS::ImplRet_OPT *ast)
{
    switch (ast->form)
    {
        case ASTNS::ImplRet_OPT::Form::A:
            retl = getL(ast->implret.get());
            retf = getF(ast->implret.get());
...
void LocationVisitor::visitLineEnding_OPT(ASTNS::LineEnding_OPT *ast)
{
    switch (ast->form)
    {
        case ASTNS::LineEnding_OPT::Form::A:
            retl = getL(ast->lineending.get());
            retf = getF(ast->lineending.get());
            retr = getR(ast->lineending.get());
            break;
...
void LocationVisitor::visitNotBlockedExpr(ASTNS::NotBlockedExpr *ast)
{
    switch (ast->form)
    {
...
void LocationVisitor::visitParamList(ASTNS::ParamList *ast)
{
    switch (ast->form)
    {
        case ASTNS::ParamList::Form::A:
            ...
            retr = getR(ast->paramsegment.get());
            break;
...
void LocationVisitor::visitVarStmtItemList(ASTNS::VarStmtItemList *ast)
{
    switch (ast->form)
    {
        case ASTNS::VarStmtItemList::Form::A:
            ...
            retr = getR(ast->varstmtitemsegment.get());
            break;
...
void LocationVisitor::visitVarStmt_OPT(ASTNS::VarStmt_OPT *ast)
{
    switch (ast->form)
    {
        case ASTNS::VarStmt_OPT::Form::A:
            retl = getL(ast->varstmt.get());
            retf = getF(ast->varstmt.get());
            retr = getR(ast->varstmt.get());
            break;
