...
// The following code was autogenerated - see the utils/ directory
void LocationVisitor::visitAdd(ASTNS::Add *ast)
{
    switch (ast->form)
    {
...
void LocationVisitor::visitMult(ASTNS::Mult *ast)
{
    switch (ast->form)
    {
...
void LocationVisitor::visitNew_expr(ASTNS::New_expr *ast)
{
    switch (ast->form)
    {
...
void LocationVisitor::visitNew_stmt(ASTNS::New_stmt *ast)
{
    switch (ast->form)
    {
