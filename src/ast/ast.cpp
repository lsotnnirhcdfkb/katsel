...
void ASTNS::AdditionExpr::accept(Visitors::ExprBVisitor *v) { v->visitAdditionExpr(this); }
ASTNS::Arg::Arg(std::unique_ptr<ExprB> expr): expr(std::move(expr)), form(ASTNS::Arg::Form::A) {}
void ASTNS::Arg::accept(Visitors::ArgBVisitor *v) { v->visitArg(this); }
...
void ASTNS::ArgList::accept(Visitors::ArgBVisitor *v) { v->visitArgList(this); }
...
void ASTNS::AssignmentExpr::accept(Visitors::ExprBVisitor *v) { v->visitAssignmentExpr(this); }
...
void ASTNS::BinandExpr::accept(Visitors::ExprBVisitor *v) { v->visitBinandExpr(this); }
...
void ASTNS::BinnotExpr::accept(Visitors::ExprBVisitor *v) { v->visitBinnotExpr(this); }
...
void ASTNS::BinorExpr::accept(Visitors::ExprBVisitor *v) { v->visitBinorExpr(this); }
...
void ASTNS::BitandExpr::accept(Visitors::ExprBVisitor *v) { v->visitBitandExpr(this); }
...
void ASTNS::BitorExpr::accept(Visitors::ExprBVisitor *v) { v->visitBitorExpr(this); }
...
void ASTNS::BitshiftExpr::accept(Visitors::ExprBVisitor *v) { v->visitBitshiftExpr(this); }
...
void ASTNS::BitxorExpr::accept(Visitors::ExprBVisitor *v) { v->visitBitxorExpr(this); }
...
void ASTNS::Block::accept(Visitors::StmtBVisitor *v) { v->visitBlock(this); }
ASTNS::BuiltinTypeNoVoid::BuiltinTypeNoVoid(Token type): type(type), form(ASTNS::BuiltinTypeNoVoid::Form::T) {}
void ASTNS::BuiltinTypeNoVoid::accept(Visitors::TypeBVisitor *v) { v->visitBuiltinTypeNoVoid(this); }
ASTNS::BuiltinTypeVoid::BuiltinTypeVoid(Token type): type(type), form(ASTNS::BuiltinTypeVoid::Form::T) {}
void ASTNS::BuiltinTypeVoid::accept(Visitors::TypeBVisitor *v) { v->visitBuiltinTypeVoid(this); }
...
void ASTNS::CallExpr::accept(Visitors::ExprBVisitor *v) { v->visitCallExpr(this); }
...
void ASTNS::CompeqExpr::accept(Visitors::ExprBVisitor *v) { v->visitCompeqExpr(this); }
...
void ASTNS::ComplgtExpr::accept(Visitors::ExprBVisitor *v) { v->visitComplgtExpr(this); }
...
void ASTNS::DeclList::accept(Visitors::DeclBVisitor *v) { v->visitDeclList(this); }
ASTNS::EmptyStmt::EmptyStmt(Token semi): semi(semi), form(ASTNS::EmptyStmt::Form::T) {}
void ASTNS::EmptyStmt::accept(Visitors::StmtBVisitor *v) { v->visitEmptyStmt(this); }
ASTNS::ExprStmt::ExprStmt(std::unique_ptr<ExprB> expr, Token semi): expr(std::move(expr)), semi(semi), form(ASTNS::ExprStmt::Form::AT) {}
void ASTNS::ExprStmt::accept(Visitors::StmtBVisitor *v) { v->visitExprStmt(this); }
...
void ASTNS::Function::accept(Visitors::DeclBVisitor *v) { v->visitFunction(this); }
...
void ASTNS::MultExpr::accept(Visitors::ExprBVisitor *v) { v->visitMultExpr(this); }
ASTNS::Param::Param(std::unique_ptr<TypeB> type, Token name): type(std::move(type)), name(name), form(ASTNS::Param::Form::AT) {}
void ASTNS::Param::accept(Visitors::PListBVisitor *v) { v->visitParam(this); }
...
void ASTNS::ParamList::accept(Visitors::PListBVisitor *v) { v->visitParamList(this); }
...
void ASTNS::PrimaryExpr::accept(Visitors::ExprBVisitor *v) { v->visitPrimaryExpr(this); }
...
void ASTNS::RetStmt::accept(Visitors::StmtBVisitor *v) { v->visitRetStmt(this); }
...
void ASTNS::StmtList::accept(Visitors::StmtBVisitor *v) { v->visitStmtList(this); }
...
void ASTNS::TernaryExpr::accept(Visitors::ExprBVisitor *v) { v->visitTernaryExpr(this); }
...
void ASTNS::UnaryExpr::accept(Visitors::ExprBVisitor *v) { v->visitUnaryExpr(this); }
...
void ASTNS::VarStmt::accept(Visitors::StmtBVisitor *v) { v->visitVarStmt(this); }
...
void ASTNS::VarStmtItem::accept(Visitors::VStmtIBVisitor *v) { v->visitVarStmtItem(this); }
...
void ASTNS::VarStmtItemList::accept(Visitors::VStmtIBVisitor *v) { v->visitVarStmtItemList(this); }
