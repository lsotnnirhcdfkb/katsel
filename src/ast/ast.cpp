...
void ASTNS::DeclList::accept(NNPtr<ASTNS::ListB::Visitor> v) { v->visitDeclList(this); }
...
void ASTNS::StmtList::accept(NNPtr<ASTNS::ListB::Visitor> v) { v->visitStmtList(this); }
...
void ASTNS::ParamList::accept(NNPtr<ASTNS::ListB::Visitor> v) { v->visitParamList(this); }
...
void ASTNS::ArgList::accept(NNPtr<ASTNS::ListB::Visitor> v) { v->visitArgList(this); }
...
void ASTNS::VarStmtItemList::accept(NNPtr<ASTNS::ListB::Visitor> v) { v->visitVarStmtItemList(this); }
...
void ASTNS::ImplMemberList::accept(NNPtr<ASTNS::ListB::Visitor> v) { v->visitImplMemberList(this); }
...
void ASTNS::PureLocation::accept(NNPtr<ASTNS::PureLocationB::Visitor> v) { v->visitPureLocation(this); }
...
void ASTNS::ImplicitDecl::accept(NNPtr<ASTNS::Decl::Visitor> v) { v->visitImplicitDecl(this); }
...
void ASTNS::CU::accept(NNPtr<ASTNS::CUB::Visitor> v) { v->visitCU(this); }
...
void ASTNS::ImplDecl::accept(NNPtr<ASTNS::Decl::Visitor> v) { v->visitImplDecl(this); }
...
void ASTNS::FunctionDecl::accept(NNPtr<ASTNS::Decl::Visitor> v) { v->visitFunctionDecl(this); }
...
void ASTNS::FunctionImplMember::accept(NNPtr<ASTNS::ImplMember::Visitor> v) { v->visitFunctionImplMember(this); }
...
void ASTNS::VarStmt::accept(NNPtr<ASTNS::Stmt::Visitor> v) { v->visitVarStmt(this); }
...
void ASTNS::VarStmtItem::accept(NNPtr<ASTNS::VStmtIB::Visitor> v) { v->visitVarStmtItem(this); }
...
void ASTNS::ExprStmt::accept(NNPtr<ASTNS::Stmt::Visitor> v) { v->visitExprStmt(this); }
...
void ASTNS::RetStmt::accept(NNPtr<ASTNS::Stmt::Visitor> v) { v->visitRetStmt(this); }
...
void ASTNS::PathType::accept(NNPtr<ASTNS::Type::Visitor> v) { v->visitPathType(this); }
...
void ASTNS::PointerType::accept(NNPtr<ASTNS::Type::Visitor> v) { v->visitPointerType(this); }
...
void ASTNS::ThisType::accept(NNPtr<ASTNS::Type::Visitor> v) { v->visitThisType(this); }
...
void ASTNS::Arg::accept(NNPtr<ASTNS::ArgB::Visitor> v) { v->visitArg(this); }
...
void ASTNS::Param::accept(NNPtr<ASTNS::ParamB::Visitor> v) { v->visitParam(this); }
...
void ASTNS::ThisParam::accept(NNPtr<ASTNS::ParamB::Visitor> v) { v->visitThisParam(this); }
...
void ASTNS::Block::accept(NNPtr<ASTNS::Expr::Visitor> v) { v->visitBlock(this); }
...
void ASTNS::IfExpr::accept(NNPtr<ASTNS::Expr::Visitor> v) { v->visitIfExpr(this); }
...
void ASTNS::WhileExpr::accept(NNPtr<ASTNS::Expr::Visitor> v) { v->visitWhileExpr(this); }
...
void ASTNS::AssignmentExpr::accept(NNPtr<ASTNS::Expr::Visitor> v) { v->visitAssignmentExpr(this); }
...
void ASTNS::ShortCircuitExpr::accept(NNPtr<ASTNS::Expr::Visitor> v) { v->visitShortCircuitExpr(this); }
...
void ASTNS::BinaryExpr::accept(NNPtr<ASTNS::Expr::Visitor> v) { v->visitBinaryExpr(this); }
...
void ASTNS::CastExpr::accept(NNPtr<ASTNS::Expr::Visitor> v) { v->visitCastExpr(this); }
...
void ASTNS::UnaryExpr::accept(NNPtr<ASTNS::Expr::Visitor> v) { v->visitUnaryExpr(this); }
...
void ASTNS::AddrofExpr::accept(NNPtr<ASTNS::Expr::Visitor> v) { v->visitAddrofExpr(this); }
...
void ASTNS::DerefExpr::accept(NNPtr<ASTNS::Expr::Visitor> v) { v->visitDerefExpr(this); }
...
void ASTNS::CallExpr::accept(NNPtr<ASTNS::Expr::Visitor> v) { v->visitCallExpr(this); }
...
void ASTNS::FieldAccessExpr::accept(NNPtr<ASTNS::Expr::Visitor> v) { v->visitFieldAccessExpr(this); }
...
void ASTNS::MethodCallExpr::accept(NNPtr<ASTNS::Expr::Visitor> v) { v->visitMethodCallExpr(this); }
...
void ASTNS::PrimaryExpr::accept(NNPtr<ASTNS::Expr::Visitor> v) { v->visitPrimaryExpr(this); }
...
void ASTNS::PathExpr::accept(NNPtr<ASTNS::Expr::Visitor> v) { v->visitPathExpr(this); }
...
void ASTNS::Path::accept(NNPtr<ASTNS::PathB::Visitor> v) { v->visitPath(this); }
