...
ASTNS::FunctionDecl::FunctionDecl(File const &file, Maybe<Span const> const &span, std::unique_ptr<Type> retty, Token name, std::vector<std::unique_ptr<ParamB>> params, std::unique_ptr<Block> body): Decl(file), _span(span), retty(std::move(retty)), name(std::move(name)), params(std::move(params)), body(std::move(body)) {}
...
ASTNS::VarStmtItem::VarStmtItem(File const &file, Maybe<Span const> const &span, std::unique_ptr<Type> type, bool mut, Token name, Token equal, std::unique_ptr<Expr> expr): VStmtIB(file), _span(span), type(std::move(type)), mut(std::move(mut)), name(std::move(name)), equal(std::move(equal)), expr(std::move(expr)) {}
...
ASTNS::ThisType::ThisType(File const &file, Maybe<Span const> const &span, Token th): Type(file), _span(span), th(std::move(th)) {}
...
ASTNS::Param::Param(File const &file, Maybe<Span const> const &span, std::unique_ptr<Type> type, Token name, bool mut): ParamB(file), _span(span), type(std::move(type)), name(std::move(name)), mut(std::move(mut)) {}
...
ASTNS::IfExpr::IfExpr(File const &file, Maybe<Span const> const &span, Token iftok, Token elsetok, std::unique_ptr<Expr> cond, std::unique_ptr<Expr> trues, std::unique_ptr<Expr> falses): Expr(file), _span(span), iftok(std::move(iftok)), elsetok(std::move(elsetok)), cond(std::move(cond)), trues(std::move(trues)), falses(std::move(falses)) {}
...
ASTNS::AssignmentExpr::AssignmentExpr(File const &file, Maybe<Span const> const &span, std::unique_ptr<Expr> target, Token equal, std::unique_ptr<Expr> expr): Expr(file), _span(span), target(std::move(target)), equal(std::move(equal)), expr(std::move(expr)) {}
...
ASTNS::ShortCircuitExpr::ShortCircuitExpr(File const &file, Maybe<Span const> const &span, std::unique_ptr<Expr> lhs, Token op, std::unique_ptr<Expr> rhs): Expr(file), _span(span), lhs(std::move(lhs)), op(std::move(op)), rhs(std::move(rhs)) {}
...
ASTNS::BinaryExpr::BinaryExpr(File const &file, Maybe<Span const> const &span, std::unique_ptr<Expr> lhs, Token op, std::unique_ptr<Expr> rhs): Expr(file), _span(span), lhs(std::move(lhs)), op(std::move(op)), rhs(std::move(rhs)) {}
...
ASTNS::UnaryExpr::UnaryExpr(File const &file, Maybe<Span const> const &span, Token op, std::unique_ptr<Expr> expr): Expr(file), _span(span), op(std::move(op)), expr(std::move(expr)) {}
...
ASTNS::AddrofExpr::AddrofExpr(File const &file, Maybe<Span const> const &span, Token op, std::unique_ptr<Expr> expr, bool mut): Expr(file), _span(span), op(std::move(op)), expr(std::move(expr)), mut(std::move(mut)) {}
...
ASTNS::DerefExpr::DerefExpr(File const &file, Maybe<Span const> const &span, Token op, std::unique_ptr<Expr> expr): Expr(file), _span(span), op(std::move(op)), expr(std::move(expr)) {}
...
ASTNS::CallExpr::CallExpr(File const &file, Maybe<Span const> const &span, std::unique_ptr<Expr> callee, Token oparn, std::vector<std::unique_ptr<Arg>> args): Expr(file), _span(span), callee(std::move(callee)), oparn(std::move(oparn)), args(std::move(args)) {}
void ASTNS::CallExpr::accept(ASTNS::ExprVisitor &v) { v.visit(*this); }
Maybe<Span const> const &ASTNS::CallExpr::span() const { return _span; }
ASTNS::FieldAccessExpr::FieldAccessExpr(File const &file, Maybe<Span const> const &span, std::unique_ptr<Expr> operand, Token dot, Token field): Expr(file), _span(span), operand(std::move(operand)), dot(std::move(dot)), field(std::move(field)) {}
...
ASTNS::PrimaryExpr::PrimaryExpr(File const &file, Maybe<Span const> const &span, Token value): Expr(file), _span(span), value(std::move(value)) {}
...
ASTNS::Path::Path(File const &file, Maybe<Span const> const &span, std::vector<Token> segments): PathB(file), _span(span), segments(std::move(segments)) {}
