...
void ASTNS::Expr_OPT::accept(ASTNS::ExprBVisitor *v) { v->visitExpr_OPT(this); }
...
void ASTNS::ForExpr::accept(ASTNS::ExprBVisitor *v) { v->visitForExpr(this); }
...
void ASTNS::VarStmt_OPT::accept(ASTNS::StmtBVisitor *v) { v->visitVarStmt_OPT(this); }
