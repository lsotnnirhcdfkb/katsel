...
void DotVisitor::visitArgList(ASTNS::ArgList *a)
{
    std::string thisid = curid();
    switch (a->form)
    {
...
void DotVisitor::visitBuiltinTypeNoVoid(ASTNS::BuiltinTypeNoVoid *a)
{
    std::string thisid = curid();
    switch (a->form)
    {
...
void DotVisitor::visitBuiltinTypeVoid(ASTNS::BuiltinTypeVoid *a)
{
    std::string thisid = curid();
    switch (a->form)
    {
...
void DotVisitor::visitVarStmtItemList(ASTNS::VarStmtItemList *a)
{
    std::string thisid = curid();
    switch (a->form)
    {
