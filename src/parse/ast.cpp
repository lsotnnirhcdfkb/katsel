...
ASTNS::Varstmtitems::Varstmtitems(std::unique_ptr<AST> items, std::unique_ptr<AST> item): items(std::move(items)), item(std::move(item)), form(ASTNS::Varstmtitems::Form::ITEMS_ITEM) {}
