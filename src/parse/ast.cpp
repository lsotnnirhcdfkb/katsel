...
#include "parse/ast.h"
ASTNS::Add::Add(std::unique_ptr<NewBaseAST> lhs, Token op, std::unique_ptr<NewBaseAST> rhs): lhs(std::move(lhs)), op(op), rhs(std::move(rhs)), form(ASTNS::Add::Form::PTP) {}
void ASTNS::Add::accept(ASTVisitor *v) { v->visitAdd(this); }
ASTNS::Mult::Mult(std::unique_ptr<NewBaseAST> lhs, Token op, std::unique_ptr<NewBaseAST> rhs): lhs(std::move(lhs)), op(op), rhs(std::move(rhs)), form(ASTNS::Mult::Form::PTP) {}
void ASTNS::Mult::accept(ASTVisitor *v) { v->visitMult(this); }
ASTNS::New_expr::New_expr(std::unique_ptr<NewBaseAST> expr): expr(std::move(expr)), form(ASTNS::New_expr::Form::P) {}
void ASTNS::New_expr::accept(ASTVisitor *v) { v->visitNew_expr(this); }
ASTNS::New_stmt::New_stmt(std::unique_ptr<NewBaseAST> expr): expr(std::move(expr)), form(ASTNS::New_stmt::Form::P) {}
...
ASTNS::Primary::Primary(Token oparn, std::unique_ptr<NewBaseAST> expr, Token cparn): oparn(oparn), expr(std::move(expr)), cparn(cparn), form(ASTNS::Primary::Form::TPT) {}
void ASTNS::Primary::accept(ASTVisitor *v) { v->visitPrimary(this); }
ASTNS::Unary::Unary(Token op, std::unique_ptr<NewBaseAST> operand): op(op), operand(std::move(operand)), form(ASTNS::Unary::Form::TP) {}
