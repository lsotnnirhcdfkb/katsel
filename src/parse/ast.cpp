...
ASTNS::Args::Args(std::unique_ptr<_ARGSBASE> args, Token comma, std::unique_ptr<_ARGSBASE> expr): args(std::move(args)), comma(comma), expr(std::move(expr)), form(ASTNS::Args::Form::ATA) {}
ASTNS::Args::Args(std::unique_ptr<_ARGSBASE> expr): expr(std::move(expr)), form(ASTNS::Args::Form::A) {}
...
ASTNS::CallExpr::CallExpr(std::unique_ptr<Expr> callee, Token oparn, std::unique_ptr<Expr> args, Token cparn): callee(std::move(callee)), oparn(oparn), args(std::move(args)), cparn(cparn), form(ASTNS::CallExpr::Form::ATAT) {}
...
ASTNS::Decls::Decls(std::unique_ptr<_DECLSBASE> decls, std::unique_ptr<_DECLSBASE> decl): decls(std::move(decls)), decl(std::move(decl)), form(ASTNS::Decls::Form::AA) {}
...
ASTNS::ExprStmt::ExprStmt(std::unique_ptr<_STMTBASE> expr, Token semi): expr(std::move(expr)), semi(semi), form(ASTNS::ExprStmt::Form::AT) {}
...
ASTNS::Function::Function(Token fun, std::unique_ptr<_DECLBASE> retty, Token name, Token oparn, Token cparn, std::unique_ptr<_DECLBASE> body): fun(fun), retty(std::move(retty)), name(name), oparn(oparn), cparn(cparn), body(std::move(body)), form(ASTNS::Function::Form::TATTTA) {}
ASTNS::Function::Function(Token fun, std::unique_ptr<_DECLBASE> retty, Token name, Token oparn, std::unique_ptr<_DECLBASE> paramlist, Token cparn, std::unique_ptr<_DECLBASE> body): fun(fun), retty(std::move(retty)), name(name), oparn(oparn), paramlist(std::move(paramlist)), cparn(cparn), body(std::move(body)), form(ASTNS::Function::Form::TATTATA) {}
...
ASTNS::ParamList::ParamList(std::unique_ptr<_PLISTBASE> plist, Token comma, std::unique_ptr<_PLISTBASE> type, Token name): plist(std::move(plist)), comma(comma), type(std::move(type)), name(name), form(ASTNS::ParamList::Form::ATAT) {}
ASTNS::ParamList::ParamList(std::unique_ptr<_PLISTBASE> type, Token name): type(std::move(type)), name(name), form(ASTNS::ParamList::Form::AT) {}
...
ASTNS::RetStmt::RetStmt(Token ret, std::unique_ptr<_STMTBASE> expr, Token semi): ret(ret), expr(std::move(expr)), semi(semi), form(ASTNS::RetStmt::Form::TAT) {}
...
ASTNS::Stmts::Stmts(std::unique_ptr<_STMTSBASE> stmts, std::unique_ptr<_STMTSBASE> stmt): stmts(std::move(stmts)), stmt(std::move(stmt)), form(ASTNS::Stmts::Form::AA) {}
...
ASTNS::VarStmt::VarStmt(Token var, std::unique_ptr<_STMTBASE> type, std::unique_ptr<_STMTBASE> assignments, Token semi): var(var), type(std::move(type)), assignments(std::move(assignments)), semi(semi), form(ASTNS::VarStmt::Form::TAAT) {}
void ASTNS::VarStmt::accept(_STMTBASEVisitor *v) { v->visitVarStmt(this); }
ASTNS::VarStmtItem::VarStmtItem(Token name, Token equal, std::unique_ptr<_VSTMTI> expr): name(name), equal(equal), expr(std::move(expr)), form(ASTNS::VarStmtItem::Form::TTA) {}
...
ASTNS::VarStmtItems::VarStmtItems(std::unique_ptr<_VSTMTIS> items, Token comma, std::unique_ptr<_VSTMTIS> item): items(std::move(items)), comma(comma), item(std::move(item)), form(ASTNS::VarStmtItems::Form::ATA) {}
