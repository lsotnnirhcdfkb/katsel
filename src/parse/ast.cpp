...
ASTNS::Args::Args(std::unique_ptr<_ARGS> args, Token comma, std::unique_ptr<Expr> expr): args(std::move(args)), comma(comma), expr(std::move(expr)), form(ASTNS::Args::Form::ATA) {}
ASTNS::Args::Args(std::unique_ptr<Expr> expr): expr(std::move(expr)), form(ASTNS::Args::Form::A) {}
void ASTNS::Args::accept(_ARGSVisitor *v) { v->visitArgs(this); }
...
ASTNS::Block::Block(Token ocurb, std::unique_ptr<_STMT> stmts, Token ccurb): ocurb(ocurb), stmts(std::move(stmts)), ccurb(ccurb), form(ASTNS::Block::Form::TAT) {}
ASTNS::Block::Block(Token ocurb, Token ccurb): ocurb(ocurb), ccurb(ccurb), form(ASTNS::Block::Form::TT) {}
void ASTNS::Block::accept(_STMTVisitor *v) { v->visitBlock(this); }
ASTNS::CallExpr::CallExpr(std::unique_ptr<Expr> callee, Token oparn, std::unique_ptr<_ARGS> args, Token cparn): callee(std::move(callee)), oparn(oparn), args(std::move(args)), cparn(cparn), form(ASTNS::CallExpr::Form::ATAT) {}
...
void ASTNS::Decl::accept(_DECLVisitor *v) { v->visitDecl(this); }
ASTNS::Decls::Decls(std::unique_ptr<_DECL> decls, std::unique_ptr<_DECL> decl): decls(std::move(decls)), decl(std::move(decl)), form(ASTNS::Decls::Form::AA) {}
void ASTNS::Decls::accept(_DECLVisitor *v) { v->visitDecls(this); }
ASTNS::EmptyStmt::EmptyStmt(Token semi): semi(semi), form(ASTNS::EmptyStmt::Form::T) {}
void ASTNS::EmptyStmt::accept(_STMTVisitor *v) { v->visitEmptyStmt(this); }
ASTNS::ExprStmt::ExprStmt(std::unique_ptr<Expr> expr, Token semi): expr(std::move(expr)), semi(semi), form(ASTNS::ExprStmt::Form::AT) {}
void ASTNS::ExprStmt::accept(_STMTVisitor *v) { v->visitExprStmt(this); }
void ASTNS::Expression::accept(ExprVisitor *v) { v->visitExpression(this); }
ASTNS::Function::Function(Token fun, std::unique_ptr<_TYPE> retty, Token name, Token oparn, Token cparn, std::unique_ptr<_STMT> body): fun(fun), retty(std::move(retty)), name(name), oparn(oparn), cparn(cparn), body(std::move(body)), form(ASTNS::Function::Form::TATTTA) {}
ASTNS::Function::Function(Token fun, std::unique_ptr<_TYPE> retty, Token name, Token oparn, std::unique_ptr<_PLIST> paramlist, Token cparn, std::unique_ptr<_STMT> body): fun(fun), retty(std::move(retty)), name(name), oparn(oparn), paramlist(std::move(paramlist)), cparn(cparn), body(std::move(body)), form(ASTNS::Function::Form::TATTATA) {}
void ASTNS::Function::accept(_DECLVisitor *v) { v->visitFunction(this); }
...
ASTNS::ParamList::ParamList(std::unique_ptr<_PLIST> plist, Token comma, std::unique_ptr<_TYPE> type, Token name): plist(std::move(plist)), comma(comma), type(std::move(type)), name(name), form(ASTNS::ParamList::Form::ATAT) {}
ASTNS::ParamList::ParamList(std::unique_ptr<_TYPE> type, Token name): type(std::move(type)), name(name), form(ASTNS::ParamList::Form::AT) {}
void ASTNS::ParamList::accept(_PLISTVisitor *v) { v->visitParamList(this); }
...
void ASTNS::RetStmt::accept(_STMTVisitor *v) { v->visitRetStmt(this); }
void ASTNS::Stmt::accept(_STMTVisitor *v) { v->visitStmt(this); }
ASTNS::Stmts::Stmts(std::unique_ptr<_STMT> stmts, std::unique_ptr<_STMT> stmt): stmts(std::move(stmts)), stmt(std::move(stmt)), form(ASTNS::Stmts::Form::AA) {}
void ASTNS::Stmts::accept(_STMTVisitor *v) { v->visitStmts(this); }
...
void ASTNS::Type::accept(_TYPEVisitor *v) { v->visitType(this); }
...
ASTNS::VarStmt::VarStmt(Token var, std::unique_ptr<_TYPE> type, std::unique_ptr<_VSTMTIS> assignments, Token semi): var(var), type(std::move(type)), assignments(std::move(assignments)), semi(semi), form(ASTNS::VarStmt::Form::TAAT) {}
void ASTNS::VarStmt::accept(_STMTVisitor *v) { v->visitVarStmt(this); }
