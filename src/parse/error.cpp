...
#define TRYSUB(ty)\
    ...
    // try single-symbol substitutions
    TRYSUB(TokenType::EOF_)
    TRYSUB(TokenType::FUN)
    TRYSUB(TokenType::IDENTIFIER)
    TRYSUB(TokenType::OPARN)
    TRYSUB(TokenType::CPARN)
    TRYSUB(TokenType::VAR)
    TRYSUB(TokenType::SEMICOLON)
    TRYSUB(TokenType::RETURN)
    TRYSUB(TokenType::COMMA)
    TRYSUB(TokenType::EQUAL)
    TRYSUB(TokenType::OCURB)
    TRYSUB(TokenType::CCURB)
    TRYSUB(TokenType::UINT8)
    TRYSUB(TokenType::UINT16)
    TRYSUB(TokenType::UINT32)
    TRYSUB(TokenType::UINT64)
    TRYSUB(TokenType::SINT8)
    TRYSUB(TokenType::SINT16)
    TRYSUB(TokenType::SINT32)
    TRYSUB(TokenType::SINT64)
    TRYSUB(TokenType::FLOAT)
    TRYSUB(TokenType::BOOL)
    TRYSUB(TokenType::DOUBLE)
    TRYSUB(TokenType::VOID)
    TRYSUB(TokenType::CHAR)
    TRYSUB(TokenType::QUESTION)
    TRYSUB(TokenType::COLON)
    TRYSUB(TokenType::DOUBLEPIPE)
    TRYSUB(TokenType::DOUBLEAMPER)
    TRYSUB(TokenType::BANG)
    TRYSUB(TokenType::BANGEQUAL)
    TRYSUB(TokenType::DOUBLEEQUAL)
    TRYSUB(TokenType::LESS)
    TRYSUB(TokenType::GREATER)
    TRYSUB(TokenType::LESSEQUAL)
    TRYSUB(TokenType::GREATEREQUAL)
    TRYSUB(TokenType::CARET)
    TRYSUB(TokenType::PIPE)
    TRYSUB(TokenType::AMPER)
    TRYSUB(TokenType::DOUBLEGREATER)
    TRYSUB(TokenType::DOUBLELESS)
    TRYSUB(TokenType::PLUS)
    TRYSUB(TokenType::MINUS)
    TRYSUB(TokenType::STAR)
    TRYSUB(TokenType::SLASH)
    TRYSUB(TokenType::PERCENT)
    TRYSUB(TokenType::TILDE)
    TRYSUB(TokenType::TRUELIT)
    TRYSUB(TokenType::FALSELIT)
    TRYSUB(TokenType::FLOATLIT)
    TRYSUB(TokenType::NULLPTRLIT)
    TRYSUB(TokenType::DECINTLIT)
    TRYSUB(TokenType::OCTINTLIT)
    TRYSUB(TokenType::BININTLIT)
    TRYSUB(TokenType::HEXINTLIT)
    TRYSUB(TokenType::CHARLIT)
    TRYSUB(TokenType::STRINGLIT)
    return false;
