                    ...
                    default:
                        {
                            ...
                            std::unique_ptr<ASTNS::Decl> pushitem = std::move(a0);
                            stack.emplace_back(getGoto(NonTerminal::AnotherDecl, stack.back().state), std::move(pushitem));
                        }
                        break;
                }
                break;
                    ...
                    default:
                        {
                            ...
                            stack.emplace_back(getGoto(NonTerminal::ParamList_OPT, stack.back().state), std::move(pushitem));
                        }
                        break;
                    case TokenType::DOUBLE:
                        shift(p, lasttok, lookahead, stack, steps, 20); break;
                    ...
                    case TokenType::CPARN:
                        {
                            ...
                            std::unique_ptr<ASTNS::ParamList> pushitem = std::move(a0);
                            stack.emplace_back(getGoto(NonTerminal::ParamList, stack.back().state), std::move(pushitem));
                        }
                        break;
                    default:
                        if (istrial) return false;
                    ...
                    default:
                        {
                            ...
                            stack.emplace_back(getGoto(NonTerminal::LineEnding_OPT, stack.back().state), std::move(pushitem));
                        }
                        break;
                    case TokenType::NEWLINE:
                    ...
                    default:
                        {
                            ...
                            stack.emplace_back(getGoto(NonTerminal::Block, stack.back().state), std::move(pushitem));
                        }
                        break;
                }
                break;
                    ...
                    default:
                        {
                            ...
                            std::unique_ptr<ASTNS::AST> pushitem = nullptr;
                            stack.emplace_back(getGoto(NonTerminal::LineEnding, stack.back().state), std::move(pushitem));
                        }
                        break;
                    ...
                    default:
                        {
                            ...
                            stack.emplace_back(getGoto(NonTerminal::StmtList_OPT, stack.back().state), std::move(pushitem));
                        }
                        break;
                    ...
                    default:
                        {
                            ...
                            stack.emplace_back(getGoto(NonTerminal::AnotherParam, stack.back().state), std::move(pushitem));
                        }
                        break;
                }
                break;
                    ...
                    default:
                        {
                            ...
                            stack.emplace_back(getGoto(NonTerminal::ImplRet_OPT, stack.back().state), std::move(pushitem));
                        }
                        break;
                    ...
                    default:
                        {
                            ...
                            stack.emplace_back(getGoto(NonTerminal::NotBlockedExpr, stack.back().state), std::move(pushitem));
                        }
                        break;
                }
                break;
                    ...
                    default:
                        {
                            ...
                            stack.emplace_back(getGoto(NonTerminal::VarStmt_OPT, stack.back().state), std::move(pushitem));
                        }
                        break;
                    case TokenType::VAR:
                        shift(p, lasttok, lookahead, stack, steps, 54); break;
                    ...
                    default:
                        {
                            ...
                            std::unique_ptr<ASTNS::Stmt> pushitem = std::move(a0);
                            stack.emplace_back(getGoto(NonTerminal::AnotherStmt, stack.back().state), std::move(pushitem));
                        }
                        break;
                }
                break;
                    ...
                    default:
                        {
                            ...
                            std::unique_ptr<ASTNS::Expr> pushitem = std::move(a0);
                            stack.emplace_back(getGoto(NonTerminal::Expr, stack.back().state), std::move(pushitem));
                        }
                        break;
                }
                break;
                    ...
                    default:
                        {
                            ...
                            stack.emplace_back(getGoto(NonTerminal::ArgList_OPT, stack.back().state), std::move(pushitem));
                        }
                        break;
                    case TokenType::DECINTLIT:
                        shift(p, lasttok, lookahead, stack, steps, 86); break;
                    ...
                    case TokenType::SEMICOLON:
                        {
                            ...
                            stack.emplace_back(getGoto(NonTerminal::VarStmtItemList, stack.back().state), std::move(pushitem));
                        }
                        break;
                    default:
                        if (istrial) return false;
                    ...
                    default:
                        {
                            ...
                            stack.emplace_back(getGoto(NonTerminal::Expr_OPT, stack.back().state), std::move(pushitem));
                        }
                        break;
                    case TokenType::DECINTLIT:
                        shift(p, lasttok, lookahead, stack, steps, 86); break;
                    ...
                    case TokenType::CPARN:
                        {
                            ...
                            std::unique_ptr<ASTNS::ArgList> pushitem = std::move(a0);
                            stack.emplace_back(getGoto(NonTerminal::ArgList, stack.back().state), std::move(pushitem));
                        }
                        break;
                    default:
                        if (istrial) return false;
                    ...
                    default:
                        {
                            ...
                            stack.emplace_back(getGoto(NonTerminal::AnotherVarStmtItem, stack.back().state), std::move(pushitem));
                        }
                        break;
                }
                break;
                    ...
                    default:
                        {
                            ...
                            stack.emplace_back(getGoto(NonTerminal::AnotherArg, stack.back().state), std::move(pushitem));
                        }
                        break;
                }
                break;
