...
template <typename A>
static void reduce_skip(std::vector<stackitem> &stack) {
    size_t newstate = get_goto<A>((stack.end() - 2)->state);
            ...
            case 0:
                switch (lookahead.type) {
                    default: {
                            ...
                            stack.emplace_back(get_goto(NonTerminal::CU, stack.back().state), std::move(pushitem), NonTerminal::CU);
                        }
                        break;
                    case TokenType::FUN:
...
std::unique_ptr<ASTNS::DeclList> push(std::make_unique<ASTNS::DeclList>(p.sourcefile, start, end, std::vector<std::unique_ptr<ASTNS::Decl>> {}));
        ...
        push->decls.push_back(std::move(a0));
                            ...
                            stack.emplace_back(get_goto(NonTerminal::DeclList, stack.back().state), std::move(pushitem), NonTerminal::DeclList);
                        }
                        break;
                }
                break;
            case 4:
                switch (lookahead.type) {
                    default: {
                            ...
                            stack.emplace_back(get_goto(NonTerminal::Decl, stack.back().state), std::move(pushitem), NonTerminal::Decl);
                        }
                        break;
                }
                break;
                ...
                switch (lookahead.type) {
                    default: {
                            ...
                            Maybe<Location const> end =
                                a0 ? Maybe(a0->end()) : Maybe<Location const>();
                            std::unique_ptr<ASTNS::Decl> pushitem = std::move(a0);
                            stack.emplace_back(get_goto(NonTerminal::AnotherDecl, stack.back().state), std::move(pushitem), NonTerminal::AnotherDecl);
                        }
                        break;
                }
                break;
            ...
            case 12:
                switch (lookahead.type) {
                    default: {
                            ...
                            stack.emplace_back(get_goto(NonTerminal::Type, stack.back().state), std::move(pushitem), NonTerminal::Type);
                        }
                        break;
                }
                break;
...
std::unique_ptr<ASTNS::PathType> push (std::make_unique<ASTNS::PathType>(p.sourcefile, start, end, std::move(a0)));
                            ...
                            stack.emplace_back(get_goto(NonTerminal::PathType, stack.back().state), std::move(pushitem), NonTerminal::PathType);
                        }
                        break;
...
std::unique_ptr<ASTNS::ThisType> push (std::make_unique<ASTNS::ThisType>(p.sourcefile, start, end, a0));
                            ...
                            stack.emplace_back(get_goto(NonTerminal::ThisType, stack.back().state), std::move(pushitem), NonTerminal::ThisType);
                        }
                        break;
                }
                break;
...
std::unique_ptr<ASTNS::Path> push(std::make_unique<ASTNS::Path>(p.sourcefile, start, end, std::vector<Token> {}));
        ...
        push->segments.push_back(a0);
                            ...
                            stack.emplace_back(get_goto(NonTerminal::Path, stack.back().state), std::move(pushitem), NonTerminal::Path);
                        }
                        break;
                }
                break;
...
std::unique_ptr<ASTNS::ParamList> push (std::make_unique<ASTNS::ParamList>(p.sourcefile, Maybe<Location const>(), Maybe<Location const>(), std::vector<std::unique_ptr<ASTNS::ParamB>> {}));
                            ...
                            stack.emplace_back(get_goto(NonTerminal::ParamList_OPT, stack.back().state), std::move(pushitem), NonTerminal::ParamList_OPT);
                        }
                        break;
                    case TokenType::IDENTIFIER:
                    ...
                    case TokenType::WHILE:
{
                            ...
                            stack.emplace_back(get_goto(NonTerminal::LineEnding_OPT, stack.back().state), std::move(pushitem), NonTerminal::LineEnding_OPT);
                        }
                        break;
                    case TokenType::NEWLINE:
...
std::unique_ptr<ASTNS::ImplMemberList> push (std::make_unique<ASTNS::ImplMemberList>(p.sourcefile, Maybe<Location const>(), Maybe<Location const>(), std::vector<std::unique_ptr<ASTNS::ImplMember>> {}));
                            ...
                            stack.emplace_back(get_goto(NonTerminal::ImplMemberList_OPT, stack.back().state), std::move(pushitem), NonTerminal::ImplMemberList_OPT);
                        }
                        break;
                    case TokenType::FUN:
                        shift(p, lasttok, lookahead, stack, steps, 6); break;
...
std::unique_ptr<ASTNS::PointerType> push (std::make_unique<ASTNS::PointerType>(p.sourcefile, start, end, false, std::move(a1)));
                            ...
                            stack.emplace_back(get_goto(NonTerminal::PointerType, stack.back().state), std::move(pushitem), NonTerminal::PointerType);
                        }
                        break;
                }
                break;
                ...
                switch (lookahead.type) {
                    ...
                    default: {
                            ...
                            Maybe<Location const> end =
                                a0 ? Maybe(a0->end()) : Maybe<Location const>();
                            std::unique_ptr<ASTNS::ParamList> pushitem = std::move(a0);
                            stack.emplace_back(get_goto(NonTerminal::ParamList, stack.back().state), std::move(pushitem), NonTerminal::ParamList);
                        }
                        break;
                }
                break;
...
std::unique_ptr<ASTNS::ParamList> push(std::make_unique<ASTNS::ParamList>(p.sourcefile, start, end, std::vector<std::unique_ptr<ASTNS::ParamB>> {}));
        ...
        push->params.push_back(std::move(a0));
                            std::unique_ptr<ASTNS::ParamList> pushitem = std::move(push);
                            stack.emplace_back(get_goto(NonTerminal::ParamSegment, stack.back().state), std::move(pushitem), NonTerminal::ParamSegment);
                        }
                        break;
                }
                break;
            case 30:
                switch (lookahead.type) {
                    default: {
                            ...
                            stack.emplace_back(get_goto(NonTerminal::Param, stack.back().state), std::move(pushitem), NonTerminal::Param);
                        }
                        break;
                }
                break;
...
std::unique_ptr<ASTNS::ThisParam> push (std::make_unique<ASTNS::ThisParam>(p.sourcefile, start, end, false, false));
                            ...
                            stack.emplace_back(get_goto(NonTerminal::ThisParam, stack.back().state), std::move(pushitem), NonTerminal::ThisParam);
                        }
                        break;
                }
                break;
...
std::unique_ptr<ASTNS::ImplDecl> push (std::make_unique<ASTNS::ImplDecl>(p.sourcefile, start, end, std::move(a1), std::move(a2->members)));
                            ...
                            stack.emplace_back(get_goto(NonTerminal::ImplDecl, stack.back().state), std::move(pushitem), NonTerminal::ImplDecl);
                        }
                        break;
                }
                break;
...
std::unique_ptr<ASTNS::PureLocation> push (std::make_unique<ASTNS::PureLocation>(p.sourcefile, start, end, 0));
                            ...
                            stack.emplace_back(get_goto(NonTerminal::LineEnding, stack.back().state), std::move(pushitem), NonTerminal::LineEnding);
                        }
                        break;
                }
                break;
...
std::unique_ptr<ASTNS::ImplMemberList> push(std::make_unique<ASTNS::ImplMemberList>(p.sourcefile, start, end, std::vector<std::unique_ptr<ASTNS::ImplMember>> {}));
        ...
        push->members.push_back(std::move(a0));
                            std::unique_ptr<ASTNS::ImplMemberList> pushitem = std::move(push);
                            stack.emplace_back(get_goto(NonTerminal::ImplMemberList, stack.back().state), std::move(pushitem), NonTerminal::ImplMemberList);
                        }
                        break;
                }
                break;
...
std::unique_ptr<ASTNS::FunctionImplMember> push (std::make_unique<ASTNS::FunctionImplMember>(p.sourcefile, start, end, std::move(a0)));
                            ...
                            stack.emplace_back(get_goto(NonTerminal::ImplMember, stack.back().state), std::move(pushitem), NonTerminal::ImplMember);
                        }
                        break;
                }
                break;
...
std::unique_ptr<ASTNS::Param> push (std::make_unique<ASTNS::Param>(p.sourcefile, start, end, std::move(a1), a0, false));
                            ...
                            stack.emplace_back(get_goto(NonTerminal::NormalParam, stack.back().state), std::move(pushitem), NonTerminal::NormalParam);
                        }
                        break;
                }
                break;
            ...
            case 56:
                switch (lookahead.type) {
                    default: {
                            ...
                            stack.emplace_back(get_goto(NonTerminal::ImplBody, stack.back().state), std::move(pushitem), NonTerminal::ImplBody);
                        }
                        break;
                }
                break;
            ...
            case 60:
                switch (lookahead.type) {
                    default: {
                            ...
                            stack.emplace_back(get_goto(NonTerminal::AnotherImplMember, stack.back().state), std::move(pushitem), NonTerminal::AnotherImplMember);
                        }
                        break;
                }
                break;
                ...
                switch (lookahead.type) {
                    default: {
                            ...
                            Maybe<Location const> end =
                                a0 ? Maybe(a0->end()) : Maybe<Location const>();
                            std::unique_ptr<ASTNS::ParamB> pushitem = std::move(a0);
                            stack.emplace_back(get_goto(NonTerminal::AnotherParam, stack.back().state), std::move(pushitem), NonTerminal::AnotherParam);
                        }
                        break;
                }
                break;
            case 65:
                switch (lookahead.type) {
                    default: {
                            ...
                            stack.emplace_back(get_goto(NonTerminal::TypeAnnotation, stack.back().state), std::move(pushitem), NonTerminal::TypeAnnotation);
                        }
                        break;
                }
                break;
...
std::unique_ptr<ASTNS::FunctionDecl> push (std::make_unique<ASTNS::FunctionDecl>(p.sourcefile, start, end, std::move(a5), a1, std::move(a3->params), nullptr));
                            ...
                            stack.emplace_back(get_goto(NonTerminal::FunctionDecl, stack.back().state), std::move(pushitem), NonTerminal::FunctionDecl);
                        }
                        break;
                }
                break;
            case 73:
                switch (lookahead.type) {
                    default: {
                            ...
                            stack.emplace_back(get_goto(NonTerminal::Block, stack.back().state), std::move(pushitem), NonTerminal::Block);
                        }
                        break;
                }
                break;
...
std::unique_ptr<ASTNS::StmtList> push (std::make_unique<ASTNS::StmtList>(p.sourcefile, Maybe<Location const>(), Maybe<Location const>(), std::vector<std::unique_ptr<ASTNS::Stmt>> {}));
                            ...
                            stack.emplace_back(get_goto(NonTerminal::StmtList_OPT, stack.back().state), std::move(pushitem), NonTerminal::StmtList_OPT);
                        }
                        break;
                    case TokenType::CHARLIT:
...
std::unique_ptr<ASTNS::StmtList> push(std::make_unique<ASTNS::StmtList>(p.sourcefile, start, end, std::vector<std::unique_ptr<ASTNS::Stmt>> {}));
        ...
        push->stmts.push_back(std::move(a0));
                            std::unique_ptr<ASTNS::StmtList> pushitem = std::move(push);
                            stack.emplace_back(get_goto(NonTerminal::StmtList, stack.back().state), std::move(pushitem), NonTerminal::StmtList);
                        }
                        break;
                }
                break;
            case 84:
                switch (lookahead.type) {
                    default: {
                            ...
                            stack.emplace_back(get_goto(NonTerminal::Stmt, stack.back().state), std::move(pushitem), NonTerminal::Stmt);
                        }
                        break;
                }
                break;
            ...
            case 91:
                switch (lookahead.type) {
                    default: {
                            ...
                            stack.emplace_back(get_goto(NonTerminal::NotBlockedExpr, stack.back().state), std::move(pushitem), NonTerminal::NotBlockedExpr);
                        }
                        break;
                }
                break;
                ...
                switch (lookahead.type) {
                    default: {
                            ...
                            Maybe<Location const> end =
                                a0 ? Maybe(a0->end()) : Maybe<Location const>();
                            std::unique_ptr<ASTNS::Expr> pushitem = std::move(a0);
                            stack.emplace_back(get_goto(NonTerminal::BlockedExpr, stack.back().state), std::move(pushitem), NonTerminal::BlockedExpr);
                        }
                        break;
                }
                break;
                ...
                switch (lookahead.type) {
                    default: {
                            ...
                            Maybe<Location const> end =
                                a0 ? Maybe(a0->end()) : Maybe<Location const>();
                            std::unique_ptr<ASTNS::Expr> pushitem = std::move(a0);
                            stack.emplace_back(get_goto(NonTerminal::AssignmentExpr, stack.back().state), std::move(pushitem), NonTerminal::AssignmentExpr);
                        }
                        break;
                ...
                switch (lookahead.type) {
                    default: {
                            ...
                            Maybe<Location const> end =
                                a0 ? Maybe(a0->end()) : Maybe<Location const>();
                            std::unique_ptr<ASTNS::Expr> pushitem = std::move(a0);
                            stack.emplace_back(get_goto(NonTerminal::BinOrExpr, stack.back().state), std::move(pushitem), NonTerminal::BinOrExpr);
                        }
                        break;
                ...
                switch (lookahead.type) {
                    ...
                    default: {
                            ...
                            Maybe<Location const> end =
                                a0 ? Maybe(a0->end()) : Maybe<Location const>();
                            std::unique_ptr<ASTNS::Expr> pushitem = std::move(a0);
                            stack.emplace_back(get_goto(NonTerminal::BinAndExpr, stack.back().state), std::move(pushitem), NonTerminal::BinAndExpr);
                        }
                        break;
                ...
                switch (lookahead.type) {
                    default: {
                            ...
                            Maybe<Location const> end =
                                a0 ? Maybe(a0->end()) : Maybe<Location const>();
                            std::unique_ptr<ASTNS::Expr> pushitem = std::move(a0);
                            stack.emplace_back(get_goto(NonTerminal::CompEQExpr, stack.back().state), std::move(pushitem), NonTerminal::CompEQExpr);
                        }
                        break;
                ...
                switch (lookahead.type) {
                    default: {
                            ...
                            Maybe<Location const> end =
                                a0 ? Maybe(a0->end()) : Maybe<Location const>();
                            std::unique_ptr<ASTNS::Expr> pushitem = std::move(a0);
                            stack.emplace_back(get_goto(NonTerminal::CompLGTExpr, stack.back().state), std::move(pushitem), NonTerminal::CompLGTExpr);
                        }
                        break;
                ...
                switch (lookahead.type) {
                    default: {
                            ...
                            Maybe<Location const> end =
                                a0 ? Maybe(a0->end()) : Maybe<Location const>();
                            std::unique_ptr<ASTNS::Expr> pushitem = std::move(a0);
                            stack.emplace_back(get_goto(NonTerminal::BitXorExpr, stack.back().state), std::move(pushitem), NonTerminal::BitXorExpr);
                        }
                        break;
                    case TokenType::PIPE:
                ...
                switch (lookahead.type) {
                    ...
                    default: {
                            ...
                            Maybe<Location const> end =
                                a0 ? Maybe(a0->end()) : Maybe<Location const>();
                            std::unique_ptr<ASTNS::Expr> pushitem = std::move(a0);
                            stack.emplace_back(get_goto(NonTerminal::BitOrExpr, stack.back().state), std::move(pushitem), NonTerminal::BitOrExpr);
                        }
                        break;
                }
                break;
                ...
                switch (lookahead.type) {
                    default: {
                            ...
                            Maybe<Location const> end =
                                a0 ? Maybe(a0->end()) : Maybe<Location const>();
                            std::unique_ptr<ASTNS::Expr> pushitem = std::move(a0);
                            stack.emplace_back(get_goto(NonTerminal::BitAndExpr, stack.back().state), std::move(pushitem), NonTerminal::BitAndExpr);
                        }
                        break;
                ...
                switch (lookahead.type) {
                    default: {
                            ...
                            Maybe<Location const> end =
                                a0 ? Maybe(a0->end()) : Maybe<Location const>();
                            std::unique_ptr<ASTNS::Expr> pushitem = std::move(a0);
                            stack.emplace_back(get_goto(NonTerminal::BitShiftExpr, stack.back().state), std::move(pushitem), NonTerminal::BitShiftExpr);
                        }
                        break;
                    case TokenType::MINUS:
                ...
                switch (lookahead.type) {
                    default: {
                            ...
                            Maybe<Location const> end =
                                a0 ? Maybe(a0->end()) : Maybe<Location const>();
                            std::unique_ptr<ASTNS::Expr> pushitem = std::move(a0);
                            stack.emplace_back(get_goto(NonTerminal::AdditionExpr, stack.back().state), std::move(pushitem), NonTerminal::AdditionExpr);
                        }
                        break;
                ...
                switch (lookahead.type) {
                    default: {
                            ...
                            Maybe<Location const> end =
                                a0 ? Maybe(a0->end()) : Maybe<Location const>();
                            std::unique_ptr<ASTNS::Expr> pushitem = std::move(a0);
                            stack.emplace_back(get_goto(NonTerminal::MultExpr, stack.back().state), std::move(pushitem), NonTerminal::MultExpr);
                        }
                        break;
                ...
                switch (lookahead.type) {
                    default: {
                            ...
                            Maybe<Location const> end =
                                a0 ? Maybe(a0->end()) : Maybe<Location const>();
                            std::unique_ptr<ASTNS::Expr> pushitem = std::move(a0);
                            stack.emplace_back(get_goto(NonTerminal::CastExpr, stack.back().state), std::move(pushitem), NonTerminal::CastExpr);
                        }
                        break;
                }
                break;
                ...
                switch (lookahead.type) {
                    default: {
                            ...
                            Maybe<Location const> end =
                                a0 ? Maybe(a0->end()) : Maybe<Location const>();
                            std::unique_ptr<ASTNS::Expr> pushitem = std::move(a0);
                            stack.emplace_back(get_goto(NonTerminal::UnaryExpr, stack.back().state), std::move(pushitem), NonTerminal::UnaryExpr);
                        }
                        break;
                    case TokenType::OPARN:
                ...
                switch (lookahead.type) {
                    default: {
                            ...
                            Maybe<Location const> end =
                                a0 ? Maybe(a0->end()) : Maybe<Location const>();
                            std::unique_ptr<ASTNS::Expr> pushitem = std::move(a0);
                            stack.emplace_back(get_goto(NonTerminal::CallExpr, stack.back().state), std::move(pushitem), NonTerminal::CallExpr);
                        }
                        break;
                }
                break;
...
std::unique_ptr<ASTNS::PrimaryExpr> push (std::make_unique<ASTNS::PrimaryExpr>(p.sourcefile, start, end, a0));
                            ...
                            stack.emplace_back(get_goto(NonTerminal::PrimaryExpr, stack.back().state), std::move(pushitem), NonTerminal::PrimaryExpr);
                        }
                        break;
                }
                break;
...
std::unique_ptr<ASTNS::PathExpr> push (std::make_unique<ASTNS::PathExpr>(p.sourcefile, start, end, std::move(a0)));
                            std::unique_ptr<ASTNS::Expr> pushitem = std::move(push);
                            stack.emplace_back(get_goto(NonTerminal::PathExpr, stack.back().state), std::move(pushitem), NonTerminal::PathExpr);
                        }
                        break;
                    case TokenType::DOUBLECOLON:
                        shift(p, lasttok, lookahead, stack, steps, 23); break;
...
std::unique_ptr<ASTNS::Block> push (std::make_unique<ASTNS::Block>(p.sourcefile, start, end, std::move(a1->stmts)));
                            ...
                            stack.emplace_back(get_goto(NonTerminal::BracedBlock, stack.back().state), std::move(pushitem), NonTerminal::BracedBlock);
                        }
                        break;
                }
                break;
                ...
                switch (lookahead.type) {
                    default: {
                            ...
                            Maybe<Location const> end =
                                a0 ? Maybe(a0->end()) : Maybe<Location const>();
                            std::unique_ptr<ASTNS::Stmt> pushitem = std::move(a0);
                            stack.emplace_back(get_goto(NonTerminal::AnotherStmt, stack.back().state), std::move(pushitem), NonTerminal::AnotherStmt);
                        }
                        break;
                }
                break;
            ...
            case 140:
                switch (lookahead.type) {
                    ...
                    default: {
                            ...
                            stack.emplace_back(get_goto(NonTerminal::VarStmtItemList, stack.back().state), std::move(pushitem), NonTerminal::VarStmtItemList);
                        }
                        break;
                }
                break;
...
std::unique_ptr<ASTNS::VarStmtItemList> push(std::make_unique<ASTNS::VarStmtItemList>(p.sourcefile, start, end, std::vector<std::unique_ptr<ASTNS::VarStmtItem>> {}));
        ...
        push->items.push_back(std::move(a0));
                            ...
                            stack.emplace_back(get_goto(NonTerminal::VarStmtItemSegment, stack.back().state), std::move(pushitem), NonTerminal::VarStmtItemSegment);
                        }
                        break;
                }
                break;
...
std::unique_ptr<ASTNS::ExprStmt> push (std::make_unique<ASTNS::ExprStmt>(p.sourcefile, start, end, std::move(a0), false, Maybe<Location const>()));
                            ...
                            stack.emplace_back(get_goto(NonTerminal::ExprStmt, stack.back().state), std::move(pushitem), NonTerminal::ExprStmt);
                        }
                        break;
                }
                break;
...
std::unique_ptr<ASTNS::RetStmt> push (std::make_unique<ASTNS::RetStmt>(p.sourcefile, start, end, nullptr));
                            ...
                            stack.emplace_back(get_goto(NonTerminal::RetStmt, stack.back().state), std::move(pushitem), NonTerminal::RetStmt);
                        }
                        break;
                }
                break;
                ...
                switch (lookahead.type) {
                    default: {
                            ...
                            Maybe<Location const> end =
                                a0 ? Maybe(a0->end()) : Maybe<Location const>();
                            std::unique_ptr<ASTNS::Expr> pushitem = std::move(a0);
                            stack.emplace_back(get_goto(NonTerminal::Expr, stack.back().state), std::move(pushitem), NonTerminal::Expr);
                        }
                        break;
                }
                break;
...
std::unique_ptr<ASTNS::ArgList> push (std::make_unique<ASTNS::ArgList>(p.sourcefile, Maybe<Location const>(), Maybe<Location const>(), std::vector<std::unique_ptr<ASTNS::Arg>> {}));
                            ...
                            stack.emplace_back(get_goto(NonTerminal::ArgList_OPT, stack.back().state), std::move(pushitem), NonTerminal::ArgList_OPT);
                        }
                        break;
                    case TokenType::DECINTLIT:
                        shift(p, lasttok, lookahead, stack, steps, 122); break;
...
std::unique_ptr<ASTNS::Block> push (std::make_unique<ASTNS::Block>(p.sourcefile, start, end, std::move(a2->stmts)));
                            std::unique_ptr<ASTNS::Block> pushitem = std::move(push);
                            stack.emplace_back(get_goto(NonTerminal::IndentedBlock, stack.back().state), std::move(pushitem), NonTerminal::IndentedBlock);
                        }
                        break;
                }
                break;
...
std::unique_ptr<ASTNS::VarStmt> push (std::make_unique<ASTNS::VarStmt>(p.sourcefile, start, end, std::move(a1->items)));
                            ...
                            stack.emplace_back(get_goto(NonTerminal::VarStmt, stack.back().state), std::move(pushitem), NonTerminal::VarStmt);
                        }
                        break;
                }
                break;
...
std::unique_ptr<ASTNS::VarStmtItem> push (std::make_unique<ASTNS::VarStmtItem>(p.sourcefile, start, end, std::move(a1), false, a0, a0, nullptr));
                            ...
                            stack.emplace_back(get_goto(NonTerminal::VarStmtItem, stack.back().state), std::move(pushitem), NonTerminal::VarStmtItem);
                        }
                        break;
                    case TokenType::EQUAL:
...
std::unique_ptr<ASTNS::IfExpr> push (std::make_unique<ASTNS::IfExpr>(p.sourcefile, start, end, a0, a0, std::move(a1), std::move(a2), nullptr));
                            ...
                            stack.emplace_back(get_goto(NonTerminal::IfExpr, stack.back().state), std::move(pushitem), NonTerminal::IfExpr);
                        }
                        break;
                    case TokenType::ELSE:
...
std::unique_ptr<ASTNS::WhileExpr> push (std::make_unique<ASTNS::WhileExpr>(p.sourcefile, start, end, std::move(a1), std::move(a2)));
                            ...
                            stack.emplace_back(get_goto(NonTerminal::WhileExpr, stack.back().state), std::move(pushitem), NonTerminal::WhileExpr);
                        }
                        break;
                }
                break;
                ...
                switch (lookahead.type) {
                    ...
                    default: {
                            ...
                            Maybe<Location const> end =
                                a0 ? Maybe(a0->end()) : Maybe<Location const>();
                            std::unique_ptr<ASTNS::ArgList> pushitem = std::move(a0);
                            stack.emplace_back(get_goto(NonTerminal::ArgList, stack.back().state), std::move(pushitem), NonTerminal::ArgList);
                        }
                        break;
                }
                break;
...
std::unique_ptr<ASTNS::ArgList> push(std::make_unique<ASTNS::ArgList>(p.sourcefile, start, end, std::vector<std::unique_ptr<ASTNS::Arg>> {}));
        ...
        push->args.push_back(std::move(a0));
                            std::unique_ptr<ASTNS::ArgList> pushitem = std::move(push);
                            stack.emplace_back(get_goto(NonTerminal::ArgSegment, stack.back().state), std::move(pushitem), NonTerminal::ArgSegment);
                        }
                        break;
                }
                break;
...
std::unique_ptr<ASTNS::Arg> push (std::make_unique<ASTNS::Arg>(p.sourcefile, start, end, std::move(a0)));
                            ...
                            stack.emplace_back(get_goto(NonTerminal::Arg, stack.back().state), std::move(pushitem), NonTerminal::Arg);
                        }
                        break;
                }
                break;
...
std::unique_ptr<ASTNS::FieldAccessExpr> push (std::make_unique<ASTNS::FieldAccessExpr>(p.sourcefile, start, end, std::move(a0), a1, a2));
                            std::unique_ptr<ASTNS::Expr> pushitem = std::move(push);
                            stack.emplace_back(get_goto(NonTerminal::FieldAccessExpr, stack.back().state), std::move(pushitem), NonTerminal::FieldAccessExpr);
                        }
                        break;
                    case TokenType::OPARN:
            ...
            case 232:
                switch (lookahead.type) {
                    default: {
                            ...
                            stack.emplace_back(get_goto(NonTerminal::AnotherVarStmtItem, stack.back().state), std::move(pushitem), NonTerminal::AnotherVarStmtItem);
                        }
                        break;
                }
                break;
            ...
            case 248:
                switch (lookahead.type) {
                    default: {
                            ...
                            stack.emplace_back(get_goto(NonTerminal::AnotherArg, stack.back().state), std::move(pushitem), NonTerminal::AnotherArg);
                        }
                        break;
                }
                break;
...
std::unique_ptr<ASTNS::MethodCallExpr> push (std::make_unique<ASTNS::MethodCallExpr>(p.sourcefile, start, end, std::move(a0), a1, a2, a3, std::move(a4->args)));
                            std::unique_ptr<ASTNS::Expr> pushitem = std::move(push);
                            stack.emplace_back(get_goto(NonTerminal::MethodCallExpr, stack.back().state), std::move(pushitem), NonTerminal::MethodCallExpr);
                        }
                        break;
                }
                break;
