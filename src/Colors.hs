...
file_path_sgr, error_sgr, warning_sgr, note_sgr, hint_sgr, dbgmsg_sgr, empty_underline_sgr, diagcode_sgr, diagname_sgr, success_sgr, failure_sgr :: [ANSI.SGR]
