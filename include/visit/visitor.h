...
{
public:
    virtual ~ArgsBVisitor() {}    virtual void visitArgs(ASTNS::Args *ast) = 0;
};
class DeclBVisitor
{
public:
    virtual ~DeclBVisitor() {}    virtual void visitDecl(ASTNS::Decl *ast) = 0;
...
{
public:
    virtual ~ExprBVisitor() {}    virtual void visitAdditionExpr(ASTNS::AdditionExpr *ast) = 0;
...
{
public:
    virtual ~PListBVisitor() {}    virtual void visitParamList(ASTNS::ParamList *ast) = 0;
};
class StmtBVisitor
{
public:
    virtual ~StmtBVisitor() {}    virtual void visitBlock(ASTNS::Block *ast) = 0;
...
{
public:
    virtual ~TypeBVisitor() {}    virtual void visitBuiltinType(ASTNS::BuiltinType *ast) = 0;
    virtual void visitType(ASTNS::Type *ast) = 0;
};
class VStmtIBVisitor
{
public:
    virtual ~VStmtIBVisitor() {}    virtual void visitVarStmtItem(ASTNS::VarStmtItem *ast) = 0;
