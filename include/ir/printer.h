...
void visitITrunc(IR::Instrs::ITrunc *i) override;
void visitIExt(IR::Instrs::IExt *i) override;
void visitFTrunc(IR::Instrs::FTrunc *i) override;
void visitFExt(IR::Instrs::FExt *i) override;
