...
virtual void visitITrunc(IR::Instrs::ITrunc *i) = 0;
virtual void visitIExt(IR::Instrs::IExt *i) = 0;
virtual void visitFTrunc(IR::Instrs::FTrunc *i) = 0;
virtual void visitFExt(IR::Instrs::FExt *i) = 0;
