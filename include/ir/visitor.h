...
virtual void visitRegister(IR::Instrs::Register &i) = 0;
...
virtual void visitAddrof(IR::Instrs::Addrof &i) = 0;
virtual void visitDerefPtr(IR::Instrs::DerefPtr &i) = 0;
virtual void visitPtrArith(IR::Instrs::PtrArith &i) = 0;
