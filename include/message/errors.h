...
// The following code was autogenerated - see the utils/ directory
    ...
    friend void E0205(IR::ASTValue const &func, Token const &oparn, ASTNS::ArgList *argsast, std::vector<IR::ASTValue> const &args);
    ...
    friend void E0213(IR::ASTValue const &val, IR::Function *f);
    friend void E0214(Token const &name, IR::Register const *prev);
    friend void E0215(Token const &eq, IR::ASTValue const &init, IR::Register const *var);
    friend void E0216(ASTNS::AST const *ast, IR::ASTValue v, IR::Type const *newty);
