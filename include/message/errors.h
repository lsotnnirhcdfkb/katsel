...
// The following code was autogenerated - see the utils/ directory
    ...
    friend void E0208(IR::ASTValue const &truev, IR::ASTValue const &falsev, Token const &iftok);
    ...
    friend void E0219(IR::ASTValue &v);
    friend void E0220(IR::ASTValue const &truev, Token const &iftok);
