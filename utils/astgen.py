...
asts = [
    ...
    ASTClass('CU', 'std::unique_ptr<Decl>|decls', 'CUB'),
    ASTClass('FunctionDecl', 'std::unique_ptr<Type>|retty, Token|name, std::vector<std::unique_ptr<Param>>|params', 'Decl'),
    ASTClass('VarStmt', 'std::unique_ptr<Type>|type, std::vector<std::unique_ptr<VarStmtItem>>|assignments', 'Stmt'),
    ...
    ASTClass('Block', 'std::vector<std::unique_ptr<Stmt>>|stmts, std::unique_ptr<Expr>|implRet', 'Stmt'),
    ...
    ASTClass('CallExpr', 'std::unique_ptr<Expr>|callee, Token|oparn, std::vector<std::unique_ptr<Arg>>|args', 'Expr'),
