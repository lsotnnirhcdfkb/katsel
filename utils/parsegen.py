...
nt('if', 'if statement', 'StmtB')
rule('if', 'IF:if OPARN:oparn EXPR:expr CPARN:cparn $stmt:trues')
rule('if', 'IF:if OPARN:oparn EXPR:expr CPARN:cparn $stmt:trues ELSE:else $stmt:falses')
