...
jobs = [
    ...
    ('include/compiler.h'      , 'GENLLVMVISITMETHOD START'  , 'GENLLVMVISITMETHOD END'  , lambda: astgen.visitASTMethods(False, doc='Visit the {} and compile it to LLVM IR/object code')),
]
