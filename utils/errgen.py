...
errors = [
        Msg('unexpected-char',
            ...
            inputs='Span const &tok', location='tok.span',
            highlights=[
        ...
        Msg('invalid-numlit-base',
            ...
            inputs='Span const &tok', location='tok.span',
            highlights=[
                SimpleHighlight('tok.span', UNDER0, [('error', '"invalid number literal base"')]),
            ]),
        Msg('nondecimal-floatlit',
            desc='The lexer found a non-decimal floating point literal.',
            inputs='Span const &tok', location='tok.span',
            highlights=[
                SimpleHighlight('tok.span', UNDER0, [('error', '"non-decimal floating-point literal"')]),
            ]),
        Msg('invalid-char-for-base',
            desc='Invalid character in number literal for base',
            inputs='Span const &tok', location='tok.span',
            highlights=[
                SimpleHighlight('tok.span', UNDER0, [('error', '"invalid character in number literal for base"')]),
            ]),
        Msg('intlit-no-digits',
            desc='Number literal with no digits',
            inputs='Span const &tok', location='tok.span',
            highlights=[
                SimpleHighlight('tok.span', UNDER0, [('error', '"Number literal with no digits"')]),
            ]),
        ...
        Msg('unrecoverable-invalid-syntax',
            ...
            inputs='Span const &lookahead, Span const &lasttok, std::vector<std::string> const &expectations', location='lookahead.span',
            highlights=[
        ...
        Msg('simple-invalid-syntax',
            ...
            inputs='Span const &lookahead, Span const &lasttok, std::string const &bestfix, std::vector<std::string> const &expectations', location='lookahead.span',
            highlights=[
        ...
        Msg('panicking-invalid-syntax',
            ...
            inputs='Span const &lookahead, Span const &lasttok, Span const &panicuntil, std::vector<std::string> const &expectations', location='lookahead.span',
            highlights=[
                SimpleHighlight('lookahead.span', UNDER0, [('error', '"unexpected {}"', 'lookahead.stringify_type()')]),
        ...
        Msg('lhs-unsupported-op',
            ...
            inputs='IR::ASTValue const &lhs, Span const &op', location='op.span',
            highlights=[
        ...
        Msg('unary-unsupported-op',
            ...
            inputs='IR::ASTValue const &operand, Span const &_operator', location='_operator.span',
            highlights=[
        ...
        Msg('call-noncallable',
            ...
            inputs='IR::ASTValue const &func, Span const &oparn', location='oparn.span',
            highlights=[
        ...
        Msg('confl-tys-ifexpr',
            ...
            inputs='IR::ASTValue const &truev, IR::ASTValue const &falsev, Span const &iftok, Span const &elsetok', location='iftok.span',
            highlights=[
        ...
        Msg('assign-conflict-tys',
            ...
            inputs='IR::ASTValue const &lhs, IR::ASTValue const &rhs, Span const &eq', location='eq.span',
            highlights=[
        ...
        Msg('conflict-var-init-ty',
            ...
            inputs='Span const &eq, Span const &name, ASTNS::Type const &type_ast, IR::ASTValue const &init, IR::Type const &expected_type', location='eq.span',
            highlights=[
        ...
        Msg('conflict-tys-binary-op',
            ...
            inputs='IR::ASTValue const &lhs, IR::ASTValue const &rhs, Span const &op', location='op.span',
            highlights=[
                SimpleHighlight('lhs', UNDER1, [('note', '"{}"', 'lhs.type()')]),
                SimpleHighlight('rhs', UNDER1, [('note', '"{}"', 'rhs.type()')]),
        ...
        Msg('ptr-arith-rhs-not-num',
            ...
            inputs='IR::ASTValue const &lhs, Span const &optok, IR::ASTValue const &rhs', location='optok.span',
            highlights=[
        ...
        Msg('no-else-not-void',
            ...
            inputs='IR::ASTValue const &truev, Span const &iftok', location='iftok.span',
            highlights=[
        ...
        Msg('wrong-num-args',
            ...
            inputs='IR::Function const &func, ASTNS::AST const &func_ref_ast, Span const &oparn, std::vector<IR::ASTValue> const &args', location='oparn.span',
            highlights=[
        ...
        Msg('redecl-sym',
            ...
            inputs='Span const &name, IR::Value const &val', location='name.span',
            highlights=[
        ...
        Msg('redecl-var',
            ...
            inputs='Span const &name, IR::Instrs::Register const &prev', location='name.span',
            highlights=[
        ...
        Msg('no-member-in',
            ...
            inputs='IR::DeclSymbol const &prev, Span const &current', location='current.span',
            highlights=[
        ...
        Msg('assign-invalid-lhs',
            ...
            inputs='Span const &eq, IR::ASTValue const &lhs', location='eq.span',
            highlights=[
        ...
        Msg('mut-addrof-nonmut-op',
            ...
            inputs='Span const &op, IR::Instrs::DerefPtr const &as_deref', location='op.span',
            highlights=[
...
warnings = [
    Msg('extra-semi',
        ...
        inputs='Span const &semi', location='semi.span',
        highlights=[
    ...
    Msg('block-no-indent',
        ...
        inputs='Span const &obrace, Span const &cbrace', location='obrace.span',
        highlights=[
