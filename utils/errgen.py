...
# Msg class {{{1
class Msg:
    def __init__(self, code, name, *, desc, inputs, location, highlights, extra=None):
        self.code = code
        self.name = name
        self.desc = desc
        self.inputs = inputs
...
errors = [
    ...
    Msg(100, 'unrecoverable-invalid-syntax',
    ...
    Msg(101, 'simple-invalid-syntax',
        ...
        extra=(
            ...
            '    un.hint(expectation);\n'
            'e.underline(un);\n')),
    Msg(102, 'panicking-invalid-syntax',
    ...
    Msg(217, 'conflict-tys-binary-op',
